<?php /* Smarty version 2.6.12, created on 2014-08-06 07:16:09
         compiled from trip_request.tpl */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('function', 'cycle', 'trip_request.tpl', 736, false),array('modifier', 'date_format', 'trip_request.tpl', 739, false),)), $this); ?>
...
.appt_txtbox{ width:40px; height:15px; border: #999 1px solid;}
.appt_txtbox_date{ width:65px; height:15px; border: #999 1px solid;}
				  	...
				  	if(formvals.length > 0){
								...
								if(formvals[21] != \'\')							  
								  ...
								  if(formvals[29] != \'\'){
									...
									if(formvals[44] != \'\'){  $(\'#b_address\').val(formvals[44]); }
									if(formvals[45] != \'\'){  $(\'#b_city\').val(formvals[45]); }
									if(formvals[46] != \'\'){  $(\'#b_state\').val(formvals[46]); }
									if(formvals[47] != \'\'){  $(\'#b_zip\').val(formvals[47]); }
...
function PerfromAutomation1(){
		var shid =  $(\'#cisid\').val();
		if(shid != \'\'){ 
			$.post("fetchdata_patient.php", {hid: ""+shid}, function(data){
				if(data.length > 0) {
            	var fetchedData = data;
			  		formvals = new Array();	 
				    formvals = fetchedData.split(\'^\'); 
...
<form name="updReq" id="updReq" action="trip_request.php" method="post">
<table width="100%" border="0" style="background-color:#eff7ff" cellpadding="0" cellspacing="0" >
  <tr>
    <td width="36%" valign="top" style="background-color: #FFD4AA;">
    
<table width="100%" border="1" style="border-color:#FFFFFF;" class="main_table" cellpadding="0" cellspacing="0" >
<tr><td colspan="6"><div class="form_heading_1">&nbsp;&nbsp;Current Trips Information</div></td></tr>
<tr class="form_heading_1">
<td align="left" width="4%" ><strong>&nbsp;&nbsp;</strong></td>
<td align="left" width="40%" ><strong>Patient Name </strong></td>
<td align="left" width="20%" ><strong>Pick Time</strong></td>
<td align="left" width="20%"><strong>Trip Type</strong></td>
...
<td align="left" valign="top" class="grid_content"><?php echo $this->_tpl_vars['trips'][$this->_sections['q']['index']]['trip_user']; ?>
</td>
<td align="left" valign="top" class="grid_content"><?php if ($this->_tpl_vars['trips'][$this->_sections['q']['index']]['wc'] == '1'): ?> W/C<?php else: ?> <?php echo ((is_array($_tmp=$this->_tpl_vars['trips'][$this->_sections['q']['index']]['pck_time'])) ? $this->_run_mod_handler('date_format', true, $_tmp, "%H:%M") : smarty_modifier_date_format($_tmp, "%H:%M"));  endif; ?></td>
<td align="left" valign="top" class="grid_content"><?php if ($this->_tpl_vars['trips'][$this->_sections['q']['index']]['type'] == '1'): ?><img src="images/one-way.png" title="A to B Trip" width="30" height="15"><?php else: ?><img  title="Return Trip B to A" src="images/two-way.png" width="30" height="15"><?php endif; ?></td>
<td align="left" valign="top" class="grid_icon">
<?php if ($this->_tpl_vars['trips'][$this->_sections['q']['index']]['status'] == '5' || $this->_tpl_vars['trips'][$this->_sections['q']['index']]['status'] == '0'): ?>
Not-Picked
<?php endif; ?>	 
<?php if ($this->_tpl_vars['trips'][$this->_sections['q']['index']]['status'] == '6' || $this->_tpl_vars['trips'][$this->_sections['q']['index']]['status'] == '4'): ?>
Picked
<?php endif; ?>	 
</a>&nbsp;&nbsp;
</td>
...
<?php endfor; else: ?>
<tr>
<td colspan="6" align="center" valign="top" class="grid_content"><strong>No Record Found!</strong></td>
</tr>
<?php endif; ?>
    ...
    <td width="32%" valign="top" style="background-color:#FFD4D4;">                                   	
	...
	<tr><td class="labelX">Patient Name:&nbsp;<span  style="color:#F00;">*</span>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<a href="#" onclick="PerfromAutomation();" ><img src="images/populate.png" width="30" height="20" title="Auto Populate Patient Data Through Patient Name" /></a></td>
<td><input name="pname" type="text" class="txt_boxX required chars" id="pname" value="<?php echo $this->_tpl_vars['post']['pname']; ?>
" maxlength="30" onKeyUp="searchSuggest();" /><!----><div id="layer1"></div></td> </tr>
         <!--   <tr class="labelX">
              <td class="labelX" >Insurance ID:&nbsp;&nbsp;<span  style="color:#F00;">*</span>&nbsp;&nbsp;&nbsp;<a href="#" onclick="PerfromAutomation1();" ><img src="images/populate.png" width="30" height="20" title="Auto Populate Patient Data Through ID" /></a></td>
			  <td valign="top"><input type="text" name="cisid" id="cisid" value="<?php echo $this->_tpl_vars['post']['cisid']; ?>
" class="txt_boxX required" autocomplete="off"/>
</td>		</tr> 
...
" class="txt_boxX required" maxlength="100" /></td> </tr>  
<tr> <td class="labelX">Program Type:&nbsp;<span  style="color:#F00;"></span></td><td class="accesslable"><?php echo $_SESSION['prgtitle']; ?>
<input type="hidden" name="prog_lable" value="<?php echo $this->_tpl_vars['prog_lable']; ?>
"/> <input type="hidden" name="prgtitle" value="<?php echo $this->_tpl_vars['prgtitle']; ?>
" /></td></tr>
		<tr><td  class="labelX"><?php echo $_SESSION['prog_lable']; ?>
:</strong>&nbsp;<span  style="color:#F00;">*</span></td>
		<td  valign="top"> <span id="cisidsp">
		<input type="text" name="cisid" id="cisid" value="<?php echo $this->_tpl_vars['post']['cisid']; ?>
" class="txt_boxX required" onblur="return PerfromAutomation();" autocomplete="off"/></span>  
...
" <?php if ($this->_tpl_vars['post']['vehtype'] == $this->_tpl_vars['vehiclepref'][$this->_sections['q']['index']]['id']): ?>selected<?php endif; ?>><?php echo $this->_tpl_vars['vehiclepref'][$this->_sections['q']['index']]['vehtype']; ?>
		...
		<td><input name="casemanager1" type="text" class="txt_boxX required chars" id="casemanager1"  value="<?php if ($_SESSION['allowUser'] == '0'):  echo $_SESSION['user']['fname']; ?>
 <?php echo $_SESSION['user']['lname'];  else:  echo $this->_tpl_vars['post']['casemanager1'];  endif; ?>" maxlength="30" />&nbsp;<span class="SmallnoteTxt"></span></td></tr>                                                  
...
" id="phyfax" class="txt_boxX" maxlength="20" /></td></tr>
  ...
  <tr> <td class="labelX">Stretcher :</td><td class="labelX"><input type="checkbox" name="stretcher" value="Yes" <?php if ($this->_tpl_vars['post']['stretcher'] == 'Yes'): ?> checked="checked"<?php endif; ?>/>&nbsp;Yes</td><td class="labelX">Bariatric Stretcher :</td><td class="labelX"><input type="checkbox" name="bar_stretcher" value="Yes" <?php if ($this->_tpl_vars['post']['bar_stretcher'] == 'Yes'): ?> checked="checked"<?php endif; ?>/>&nbsp;Yes</td>
  </tr>
  <tr>
  <td class="labelX">&nbsp;Double Stretcher :</td><td class="labelX"><input type="checkbox" name="dstretcher" value="Yes" <?php if ($this->_tpl_vars['post']['dstretcher'] == 'Yes'): ?> checked="checked"<?php endif; ?>/>&nbsp;Yes</td></tr>
  <tr>
 ...
 <td class="labelX">Child Seat :</td><td class="labelX"><input type="checkbox" name="childseat" value="Yes" <?php if ($this->_tpl_vars['post']['childseat'] == 'Yes'): ?> checked="checked"<?php endif; ?>/>&nbsp;Yes</td>
  <td class="labelX">Oxygen O<sub>2</sub> :</td><td class="labelX"><input type="checkbox" name="oxygen" value="Yes" <?php if ($this->_tpl_vars['post']['oxygen'] == 'Yes'): ?> checked="checked" <?php endif; ?> />&nbsp;Yes</td>
	...
	<td  width="32%" valign="top" style="background-color:#E0CCA8;"><table cellpadding="1" cellspacing="5" border="0" width="100%">                          	
...
" <?php if ($this->_tpl_vars['post']['pckstate'] != ''):  if ($this->_tpl_vars['states'][$this->_sections['n']['index']]['abbr'] == $this->_tpl_vars['post']['pckstate']): ?>selected<?php endif;  elseif ($this->_tpl_vars['states'][$this->_sections['n']['index']]['abbr'] == 'AZ'): ?>selected<?php endif; ?>>
		...
		<td><input type="text" name="pckzip" id="pckzip" class="txt_boxX" value="<?php echo $this->_tpl_vars['post']['pckzip']; ?>
" maxlength="10" />
		<span class="SmallnoteTxt"></span></td></tr>
...
" id="drpzip" class="txt_boxX"/><span class="SmallnoteTxt"></span></td></tr>
...
<tr><td colspan="2"><!--<table width="100%" border="0">
  <tr>
    <td class="labelX"><input type="radio" name="day" value="monday" onchange="reoccur();"  />&nbsp;Monday</td>
     <td class="labelX"><input type="radio" name="day" value="tuseday"  onchange="reoccur();"/>&nbsp;Tuseday</td>
     <td class="labelX"><input type="radio" name="day" value="wednesday"  onchange="reoccur();"/>&nbsp;Wednesday</td>
  </tr>
  <tr>
    <td class="labelX"><input type="radio" name="day" value="thirsday"  onchange="reoccur();"/>&nbsp;Thursday</td>
     <td class="labelX"><input type="radio" name="day" value="friday"  onchange="reoccur();"/>&nbsp;Friday</td>
     <td class="labelX"><input type="radio" name="day" value="saturday"  onchange="reoccur();"/>&nbsp;Saturday</td>
  </tr>
  <tr><td class="labelX"><input type="radio" name="day" value=""  onchange="non_reoccur();"/>&nbsp;None</td></tr>
  <tr id="reoccur_a" style="display:none;">
    <td class="labelX">&nbsp;Pick Time</td>
    <td class="labelX">&nbsp;Return Time</td>
    <td class="labelX">&nbsp;Reoccur Till Date</td>
  </tr>
  <tr id="reoccur_b" style="display:none;">
    <td class="labelX">&nbsp;<input  name="reocc_appicktime" id="day1" type="text" class="appt_txtbox" value="<?php echo $this->_tpl_vars['reocc_appicktime']; ?>
" size="15" maxlength="5" onblur="return tValid(this.value,'day1');"/></td>
    <td class="labelX">&nbsp;<input  name="reocc_repicktime" id="day2"  type="text"  class="appt_txtbox" value="<?php echo $this->_tpl_vars['reocc_repicktime']; ?>
" size="15" maxlength="5" onblur="return tValid(this.value,'day2');" /></td>
    <td class="labelX">&nbsp;<input name="till_date" id="day3to" type="text"  class="appt_txtbox" value="<?php echo $this->_tpl_vars['till_date']; ?>
...
<!--<td><input  name="org_aptmonday" id="org_aptmonday" type="text" class="appt_txtbox" size="5" maxlength="5" onblur="return tValid(this.value,'org_aptmonday');" disabled="disabled"/></td>-->
...
<td><input name="tdmonday" id="tdmonday" type="text"  class="appt_txtbox_date" size="15" maxlength="10" disabled="disabled"/></td></tr>
...
<td><input name="tdtuseday" id="tdtuseday" type="text"  class="appt_txtbox_date" size="15" maxlength="10" disabled="disabled"/></td></tr>
...
<td><input name="tdwednesday" id="tdwednesday" type="text"  class="appt_txtbox_date" size="15" maxlength="10" disabled="disabled"/></td></tr>
...
<td><input name="tdthirsday" id="tdthirsday" type="text"  class="appt_txtbox_date" size="15" maxlength="10" disabled="disabled"/></td></tr>
...
<td><input name="tdfriday" id="tdfriday" type="text"  class="appt_txtbox_date" size="15" maxlength="10" disabled="disabled"/></td></tr>
...
<td><input name="tdsaturday" id="tdsaturday" type="text"  class="appt_txtbox_date" size="15" maxlength="10" disabled="disabled"/></td></tr>
<tr><td>
...
<tr><td colspan="2"><textarea name="comments" cols="35" rows="2" class="txtarea" id="comments"><?php echo $this->_tpl_vars['comments']; ?>
</textarea></td></tr> 
