<?php /* Smarty version 2.6.12, created on 2016-04-21 07:22:15
      ...
      <div class="w-row">
        <div class="w-col w-col-4 col-spc">
          ...
          <div class="div-spc more-spc">
            <p class="p-ft"><?php echo $this->_tpl_vars['contentdata']['5']['content']; ?>
</p>
          </div>
        </div>
        <div class="w-col w-col-4 col-spc">
        ...
        <div class="w-col w-col-4 col-spc">
          ...
          <div class="textwidget"><strong class="map_color"><i class="fa fa-map-marker"></i> <?php echo $this->_tpl_vars['contactinfo']['address']; ?>
,
<br><?php echo $this->_tpl_vars['contactinfo']['city']; ?>
, <?php echo $this->_tpl_vars['contactinfo']['state']; ?>
,<?php echo $this->_tpl_vars['contactinfo']['zip']; ?>
</strong>
              <br>
              <div class="contact-font-icon">
                  <div class="contact-info phone-info"><i class="fa fa-phone"></i><?php echo $this->_tpl_vars['contactinfo']['phone']; ?>
</div>
                  <div class="contact-info email-info"><i class="fa fa-fax"></i>+1 234 567 890</div>
                  <div class="contact-info time-info"><i class="fa fa-envelope-o"></i><a href="E mails:<?php echo $this->_tpl_vars['contactinfo']['email']; ?>
      ...
      <div class="w-container">
        <div class="w-row">
          <div class="w-col w-col-4 w-col-stack">
            <p class="copyright"><?php echo $this->_tpl_vars['footer']['description']; ?>
