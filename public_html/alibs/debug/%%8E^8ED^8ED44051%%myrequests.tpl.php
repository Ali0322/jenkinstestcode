<?php /* Smarty version 2.6.12, created on 2014-07-26 19:40:49
         compiled from myrequests.tpl */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('function', 'cycle', 'myrequests.tpl', 275, false),array('modifier', 'date_format', 'myrequests.tpl', 276, false),)), $this); ?>
              ...
              <tr>
                 <td align="left" valign="top"><table width="100%" cellspacing="2" cellpadding="2">
                     <tr>
                      ...
                      <td width="22%" valign="top"><input class="required txt_box" type="text" name="startdate" id="startdate" value="<?php echo $this->_tpl_vars['startdate']; ?>
" maxlength="10" />
                      ...
                      <td width="51%" valign="top"><input class="required txt_box" type="text" name="enddate" id="enddate" value="<?php echo $this->_tpl_vars['enddate']; ?>
" maxlength="10"/>
...
" <?php if ($this->_tpl_vars['appdata'][$this->_sections['q']['index']]['type'] == $this->_tpl_vars['type']): ?> selected="selected" <?php endif; ?> ><?php echo $this->_tpl_vars['appdata'][$this->_sections['q']['index']]['type']; ?>
                     ...
                     <tr>
                      ...
                      <td valign="top"><select name="st" id="st" onchange="return stchange(this.value);" class="txt_box">
                          ...
                          <option value="approved" <?php if ($this->_tpl_vars['st'] == 'approved'): ?>selected<?php endif; ?>>Approved</option>
...
');"><img src="images/delete.png" border="0" alt="Delete" title="Delete Request" /></a> </td>
                     ...
                     <tr class="form_heading1">
                      <td colspan="7" align="center"><b><?php echo $this->_tpl_vars['pages']; ?>
</b></td>
                    </tr>
                   </table>
                  <?php endif; ?> </td>
