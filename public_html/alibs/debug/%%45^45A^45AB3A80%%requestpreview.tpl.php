<?php /* Smarty version 2.6.12, created on 2018-02-13 12:37:54
...
"><img src="images/van.png" border="0" height="60px" width="100px"></a></td>
...
<tr><td width="140" class="headus">Patient Name:</td><td colspan="2" class="val"><?php echo $this->_tpl_vars['RequestDetail']['0']['clientname']; ?>
...
</td><td width="140" class="headus">Pick Time(1):</td><td width="140" class="val"><?php echo $this->_tpl_vars['RequestDetail']['0']['apptime']; ?>
</td></tr>
...
</td><td width="140" class="headus">Pick Time(2):</td><td width="140" class="val"><?php if ($this->_tpl_vars['RequestDetail']['0']['triptype'] == 'Round Trip'):  echo $this->_tpl_vars['RequestDetail']['0']['returnpickup'];  endif; ?>
<?php if ($this->_tpl_vars['RequestDetail']['0']['triptype'] == 'Three Way' || $this->_tpl_vars['RequestDetail']['0']['triptype'] == 'Four Way' || $this->_tpl_vars['RequestDetail']['0']['triptype'] == 'Five Way'):  echo $this->_tpl_vars['RequestDetail']['0']['three_pickup'];  endif; ?></td></tr>
...
</td><td width="140" class="headus">Pick Time(3):</td><td width="140" class="val"><?php if ($this->_tpl_vars['RequestDetail']['0']['triptype'] == 'Three Way'):  echo $this->_tpl_vars['returnpickup'];  endif; ?>
<?php if ($this->_tpl_vars['RequestDetail']['0']['triptype'] == 'Four Way' || $this->_tpl_vars['RequestDetail']['0']['triptype'] == 'Five Way'):  echo $this->_tpl_vars['RequestDetail']['0']['four_pickup'];  endif; ?></td></tr><?php endif; ?>
...
</td><td width="140" class="headus">Pick Time(4):</td><td width="140" class="val"><?php if ($this->_tpl_vars['RequestDetail']['0']['triptype'] == 'Four Way'):  echo $this->_tpl_vars['returnpickup'];  endif; ?>
<?php if ($this->_tpl_vars['RequestDetail']['0']['triptype'] == 'Five Way'):  echo $this->_tpl_vars['RequestDetail']['0']['five_pickup'];  endif; ?></td></tr><?php endif; ?>
...
</td><td width="140" class="headus">Pick Time(Last):</td><td width="140" class="val"><?php if ($this->_tpl_vars['RequestDetail']['0']['triptype'] == 'Five Way'):  echo $this->_tpl_vars['RequestDetail']['0']['returnpickup'];  endif; ?></td></tr><?php endif; ?>
