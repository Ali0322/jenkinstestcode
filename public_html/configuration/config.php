<?php
	...
	$adminPrefix			= "../";					//admin prefix.
		...
		/*$dbname 	= "aaji2fyxhyvmdy.cyw7r6380xvq.us-east-1.rds.amazonaws.com";				//host name.
		$dbuser 	= "nemt";	  	//database user.
		$dbpasswd 	= "Hybrid+123?";		//database passwd.
		$dbs		= "demo5";		//database name.
