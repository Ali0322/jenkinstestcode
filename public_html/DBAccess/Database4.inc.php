<?php
	...
	$smarty->template_dir = "../atpls";



	$smarty->compile_dir = "../alibs/debug";



	$smarty->plugins_dir = array('../alibs/plugins');		
...
function get_server_time()
	...
	$db = new Database;	
		...
		$time_required4 = $time_required2[0].':'.$time_required2[1].':'.$time_required2[2]; //server time 
		$time1 = explode(':',$xp[1]);
		$timehr=$time1[0]-2;
		if($time1[0] > 2)
		{
