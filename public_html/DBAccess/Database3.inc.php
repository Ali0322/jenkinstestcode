		...
		function query($sql){
			...
			if($this->rs){
				...
				$emsgyz = mysql_error() . " " . $sql; 
					...
					@mail("fahad@keystone-services.com","Error inside HTT Site: - AdminSelect",$emsgyz,"From:checkit@checklist.com");
...
/*		    if (! $this->Result){
   ...
   function convertDateFromMySQL($str){
     ...
     return $str2[1].'/'.$str2[2].'/'.substr($str2[0],2);
