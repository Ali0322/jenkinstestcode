...
function isCardMatch (cardType, cardNumber)
{
	...
	if ((ct == "VISA") && (!isVisa(cn)))
		doesMatch = false;
	if ((ct == "MASTERCARD") && (!isMasterCard(cn)))
		doesMatch = false;
	if ( ( (ct == "AMERICANEXPRESS") || (ct == "AMEX") )
                && (!isAmericanExpress(cn))) doesMatch = false;
	if ((ct == "DISCOVER") && (!isDiscover(cn)))
		doesMatch = false;
	if ((ct == "JCB") && (!isJCB(cn)))
		doesMatch = false;
	if ((ct == "DINERS") && (!isDinersClub(cn)))
		doesMatch = false;
	if ((ct == "CARTEBLANCHE") && (!isCarteBlanche(cn)))
		doesMatch = false;
	if ((ct == "ENROUTE") && (!isEnRoute(cn)))
		doesMatch = false;
	alert(doesMatch);
	return doesMatch;
