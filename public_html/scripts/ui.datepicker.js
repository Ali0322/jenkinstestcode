...
$.extend(Datepicker.prototype, {
	...
	/* Parse a string value into a date object.
	   ...
	   @return  Date - the exTrackted date value or null if value is blank */
	parseDate: function (format, value, settings) {
		...
		// ExTrackt a number from the string value
		...
		// ExTrackt a name from the string value and convert to an index
	...
	/* ExTrackt all possible characters from the date format. */
...
$.extend(DatepickerInstance.prototype, {
	...
	_generateMonthYearHeader: function(drawMonth, drawYear, minDate, maxDate, selectedDate, secondary) {
		...
		if (secondary || !this._get('changeMonth'))
			...
			html += '<select style="width:90px" class="ui-datepicker-new-month" ' +
		...
		if (secondary || !this._get('changeYear'))
			...
			html += '<select style="width:70px" class="ui-datepicker-new-year" ' +
