<?php
function sendAPNS($parameter,$driver_code,$message_admin = 0, $tripID= 0){
...
$message = 'You Have A New Admin Message';
...
stream_context_set_option($ctx,'ssl','local_cert','nemt_driver.pem');
