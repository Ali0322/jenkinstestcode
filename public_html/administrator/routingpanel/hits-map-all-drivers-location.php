...
<script type="text/javascript" src="https://maps.google.com/maps/api/js?sensor=false&key=AIzaSyBBE53xDKH93kCWSWREyehlzH8N_t2R2lw"></script>
...
function geocode() {
  ...
  loopmaker();
setTimeout(function() { loopmaker(); }, 5000);
...
<div style=" width:220px; height:80px; float:left;"><a href="http://hybridtracktrans.com" target="_blank"><img src="../images/logo.png" style="max-height:70px; max-width:200px;"></a>
...
<tr><td></td><td colspan="11">Find Address Location: <input type="text" id="address"/><input type="button" value="Find Location" onClick="geocode()"><input type="button" value="Add Marker at Address" onClick="addMarkerAtCenter()"/></td>
</tr>
<tr><td></td><td colspan="11"><p id="wait" style="color:#F00;">Please Wait... <span id="countdown">15</span> seconds.</p></td></tr>
