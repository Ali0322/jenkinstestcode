...
{if $data.0.startmilage neq ''}<strong>Start Miles:</strong>{$data.0.startmilage}{/if}
{if $data.0.endmilage neq ''}<strong>&nbsp;&nbsp;&nbsp;End Miles&nbsp;&nbsp;&nbsp;:</strong>{$data.0.endmilage}<br/>{/if}
{if $data.0.paperwork neq ''}<strong>Is there any paper work?&nbsp;&nbsp;&nbsp;:</strong>{$data.0.paperwork}<br/>{/if}
{if $data.0.personal_belonging neq ''}<strong>Are there any personal belongings?&nbsp;&nbsp;&nbsp;:</strong>{$data.0.personal_belonging}<br/>{/if}
{if $data.0.medication neq ''}<strong>Are there any medication?&nbsp;&nbsp;&nbsp;:</strong>{$data.0.medication}<br/>{/if}
    </div>-->
    </td>
     <td class="tdheight" colspan="2">
    <div style="float:left; padding-left:10px;">
{if $data.0.signature neq ''}<img src="../../iphone/signature/{$data.0.signature}" width="140" height="140" />{/if}
{if $data.0.signature2 neq ''}<img src="../../iphone/signature/{$data.0.signature2}" width="140" height="140" />{/if}
    </div>
    </td>
  </tr>
</table>
...
<tr><td colspan="6" style="height:20px;"></td></tr>
<tr><td width="140" class="headus">Account Name:</td><td class="val">{$data.0.account_name}</td></tr>
<tr><td width="140" class="headus">Client Name:</td><td class="val">{$data.0.clientname}</td><td width="140" class="headus">PO #:</td><td width="140" class="val">{$data.0.po}</td><td width="140" class="headus">Patient Weight:</td><td width="140" class="val">{$data.0.patient_weight} Lbs</td></tr>
...
<td width="140" class="headus">0xygen:</td><td width="140" class="val">{$data.0.oxygen}</td><td width="140" class="headus">Comments:</td><td width="140" class="val" colspan="5">{$data.0.comments}</td>
</tr>
  <tr></tr>
    </table>
...
<tr>
            ...
            <tr>
              ...
              <td height="25"  align="left" class="labeltxt">{$data[0].pck_time}</td>
              <td height="25"  align="left" class="labeltxt">Actual Picked Time: </td>
              <td height="25"  align="left" class="labeltxt">{$data[0].aptime}</td>
            </tr>
            <tr>
            ...
            <tr>
              ...
              <td height="25"   align="left" class="labeltxt">{$data[0].drp_time}</td>
              <td height="25"   align="left" class="labeltxt">Actual Dropped Time: </td>
              <td height="25"  align="left" class="labeltxt">{$data[0].drp_atime}</td>
            </tr>
            <tr>
       ...
       <!--     <tr>
            ...
            <!--<tr>
              ...
              <td height="25"  align="left" class="labeltxt" colspan="3">{$data.0.temp_comments}</td>
            </tr>-->
            ...
            <tr>
              ...
              <td height="25"   align="left" class="labeltxt" >
                ...
                {if $data[0].status=='2'}Reschedule{/if}
