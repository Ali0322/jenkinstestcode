...
{if $showClient eq 'no'}
								<a href="reqdetails.php?req={$reqdetails[q].account}&st=active{if $startdate neq ''}&startdate={$startdate}{/if}{if $enddate neq ''}&enddate={$enddate}{/if}{if $pname neq ''}&pname={$pname}{/if}&by_date={$by_date}{if $apptype neq ''}&apptype={$apptype}{/if}" target="_blank">Pending</a> |
                                <a href="reqdetails.php?req={$reqdetails[q].account}&st=approved{if $startdate neq ''}&startdate={$startdate}{/if}{if $enddate neq ''}&enddate={$enddate}{/if}{if $pname neq ''}&pname={$pname}{/if}&by_date={$by_date}{if $apptype neq ''}&apptype={$apptype}{/if}"  target="_blank">Approved</a> |
                                <a href="reqdetails.php?req={$reqdetails[q].account}&st=disapproved{if $startdate neq ''}&startdate={$startdate}{/if}{if $enddate neq ''}&enddate={$enddate}{/if}{if $pname neq ''}&pname={$pname}{/if}&by_date={$by_date}{if $apptype neq ''}&apptype={$apptype}{/if}"  target="_blank">Disapproved</a>

								 {else}

{if $reqdetails[q].active > 0}
                                <a href="reqdetails.php?req={$reqdetails[q].account}&cisid={$reqdetails[q].cisid}&st=active{if $startdate neq ''}&startdate={$startdate}{/if}{if $enddate neq ''}&enddate={$enddate}{/if}&by_date={$by_date}{if $apptype neq ''}&apptype={$apptype}{/if}&{if $pname neq ''}&pname={$pname}{/if}"  target="_blank">Active({$reqdetails[q].active})</a>{else}Active({$reqdetails[q].active}){/if} 
                                
                                | {if $reqdetails[q].approved > 0}
                                <a href="reqdetails.php?req={$reqdetails[q].account}&cisid={$reqdetails[q].cisid}&st=approved{if $startdate neq ''}&startdate={$startdate}{/if}{if $enddate neq ''}&enddate={$enddate}{/if}&by_date={$by_date}{if $apptype neq ''}&apptype={$apptype}{/if}&{if $pname neq ''}&pname={$pname}{/if}"  target="_blank">Approved({$reqdetails[q].approved})</a>{else}Approved({$reqdetails[q].approved}){/if}
                                
                                | {if $reqdetails[q].disapproved > 0} |
                                <a href="reqdetails.php?req={$reqdetails[q].account}&cisid={$reqdetails[q].cisid}&st=disapproved{if $startdate neq ''}&startdate={$startdate}{/if}{if $enddate neq ''}&enddate={$enddate}{/if}&by_date={$by_date}{if $apptype neq ''}&apptype={$apptype}{/if}&{if $pname neq ''}&pname={$pname}{/if}"  target="_blank">Disapproved({$reqdetails[q].disapproved})</a>{else}Disapproved({$reqdetails[q].disapproved}){/if}								
