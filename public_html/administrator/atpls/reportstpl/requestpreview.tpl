...
<tr><td width="140" class="headus">Client Name:</td><td colspan="2" class="val">{$RequestDetail.0.clientname}</td><td width="140" class="headus"></td><td  colspan="2" class="val"></td></tr>
