            ...
            {/section}
             ...
             <td align="left" valign="top">
                ...
                <tr>
                  ...
                  {if $yes eq '1'}
                  <a href="javascript:popWind('lg_print.php?startdate={$stdate}&enddate={$enddate}&driver_id={$drv_id}&status={$status}&hospname={$logiticid}')" ><input type="button" value='Print Report' class="inputButton btn"  /></a>
                    &nbsp;{/if}
