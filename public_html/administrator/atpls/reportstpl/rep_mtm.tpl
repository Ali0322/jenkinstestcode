            ...
            {/section}
             ...
             <td align="left" valign="top">
                ...
                <tr>
                  ...
                  {if $yes eq '1'}
                  <a href="javascript:popWind('rep_print.php?startdate={$stdate}&enddate={$enddate}&driver_id={$drv_id}&status={$status}&hospname={$hospname}')" ><input type="button" value='Print Report' class="inputButton btn"  /></a>
                    &nbsp;{/if}
                    {if $smarty.session.admuser.admin_level eq '0' || $smarty.session.adminpermission.mtmreports_cr eq 'on'}{/if}
