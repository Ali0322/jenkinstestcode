...
<table width="100%" border="0" align="center" cellpadding="0" cellspacing="0">
  <tr>
    <td height="44" align="center"  valign="top" style="padding-bottom:50px;"><form name="ar" id="ar" method="post" action="edit_request.php">
        ...
        <!--{if $dt.triptype eq 'Round Trip'}
        <tr><td colspan="4" style="text-align:center;"><strong>Leg B</strong></td></tr>
            <tr><td colspan="4"><hr /></td></tr>
        <tr> 
		
              <td  align="left" valign="top" class="labeltxt"><strong>2 Man Team:</strong>&nbsp;&nbsp;</td>
              <td  align="left"><input type="checkbox" name="dstretcher2" value="Yes" {if $legB.dstretcher eq 'Yes'} checked="checked"{/if}/>&nbsp;Yes&nbsp;&nbsp;@&nbsp;<input type="text" name="dstretcher_rate2" value="{$legB.dstretcher_rate}" size="5"/></td>
              <td  align="left" valign="top" class="labeltxt"><strong>Bariatric Stretcher:</strong>&nbsp;&nbsp;</td>
              <td  align="left"><input type="checkbox" name="bstretcher2" value="Yes" {if $legB.bstretcher eq 'Yes'} checked="checked"{/if}/>&nbsp;Yes&nbsp;&nbsp;@&nbsp;<input type="text" name="bstretcher_rate2" value="{$legB.bstretcher_rate}" size="5"/></td>
            </tr>
            
             <tr> 
			  
              <td  align="left" valign="top" class="labeltxt"><strong>Wheel Chair Rental:</strong>&nbsp;&nbsp;</td>
              <td  align="left"><input type="checkbox" name="doublewheel2" id="doublewheel2" value="Yes" {if $legB.doublewheel eq 'Yes'} checked="checked"{/if}/>&nbsp;Yes &nbsp;&nbsp;@&nbsp;<input type="text" name="doublewheel_rate2" value="{$legB.doublewheel_rate}" size="5"/></td>
              <td  align="left" valign="top" class="labeltxt"><strong>0xygen:</strong>&nbsp;&nbsp;</td>
              <td   align="left"><input type="checkbox" name="oxygen2" value="Yes" {if $legB.oxygen eq 'Yes'} checked="checked"{/if}/>
              &nbsp;Yes&nbsp;&nbsp;@&nbsp;<input type="text" name="oxygen_rate2" value="{$legB.oxygen_rate}" size="5"/></td>
            </tr>
             <tr>
              <td  align="left" valign="top" class="labeltxt"><strong>Wait Time?:</strong>&nbsp;&nbsp;</td>
              <td  align="left"><input type="text" name="waittime2" id="waittime2" value="{$legB.waittime}" size="7" maxlength="8" class="inputTxtField" />&nbsp;&nbsp;@&nbsp;<input type="text" name="waittime_rate2" value="{$legB.waittime_rate}" size="5"/> per 30 minute unit </td>
               <td  align="left" valign="top" class="labeltxt"><strong>No Show Apply?:</strong>&nbsp;&nbsp;</td>
              <td   align="left"><select name="noshow2">
            										<option value="0" {if $legB.noshow eq '0'}selected{/if}>No</option>
                                                    <option value="1" {if $legB.noshow eq '1'}selected{/if}>Yes</option>
                                                    </select>&nbsp;&nbsp;&nbsp;@&nbsp;<input type="text" name="noshow_rate2" value="{$legB.noshow_rate}" size="5"/></td>
      
            </tr>
             <tr>
              <td  align="left" valign="top" class="labeltxt"><strong>Free Miles:</strong>&nbsp;&nbsp;</td>
              <td  align="left"><input type="text" name="freemiles2" id="freemiles2" value="{$legB.freemiles}" size="10" maxlength="8" class="inputTxtField" /></td>
               <td  align="left" valign="top" class="labeltxt"><strong>After Hours Fee Apply?:</strong>&nbsp;&nbsp;</td>
              <td   align="left"><select name="afterhour2">
            										<option value="0" {if $legB.afterhour eq '0'}selected{/if}>No</option>
                                                    <option value="1" {if $legB.afterhour eq '1'}selected{/if}>Yes</option>
                                                    </select>&nbsp;&nbsp;&nbsp;@&nbsp;<input type="text" name="afterhour_rate2" value="{$legB.afterhour_rate}" size="5"/></td>
            </tr>
            <tr> 
			   <td  align="left" valign="top" class="labeltxt"><strong>Total Miles:</strong>&nbsp;&nbsp;</td>
              <td   align="left"><input type="text" name="miles2" value="{$legB.miles}" size="5"/>&nbsp;Billable:&nbsp;{$chargeablemile2}&nbsp;&nbsp;@&nbsp;<input type="text" name="permile_ch2" value="{$legB.permile_ch}" size="5"/></td>
              <td  align="left" valign="top" class="labeltxt"><strong>Miscellaneous Charges:</strong>&nbsp;&nbsp;</td>
              <td  align="left"><input type="text" name="miscellaneous_charges2" value="{$legB.miscellaneous_charges}" size="10" maxlength="8" class="inputTxtField" /> $ </td>
            </tr>
             <tr> 
			  <td  align="left" valign="top" class="labeltxt"><strong>Pickup Charges:</strong>&nbsp;&nbsp;</td>
              <td  align="left"><input type="text" name="pickup_ch2" value="{$legB.pickup_ch}"  /></td>
             <td  align="left" valign="top" class="labeltxt"><strong>Total Charges:</strong>&nbsp;&nbsp;</td>
             <td  align="left"><input type="text" name="charges2" value="{$legB.charges}"  /><input type="hidden" name="legB_id" value="{$legB.id}" /></td>
            </tr>
        <tr><td colspan="4"><hr /></td></tr>
        {/if}    -->
             <tr> 
