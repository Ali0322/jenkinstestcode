...
<table width="80%" border="0" cellspacing="0" cellpadding="0">
        ...
        <tr>
          <td height="19" colspan="2" align="center"><div align="right" id="add_div" style="padding-right:40px; padding-bottom:5px;"> <a title="Add" href="edi_constant.php"> EDI Constant </a> | {if $noReq neq '0'}
             ...
             <td align="left" valign="top">
              ...
              <td align="left" valign="top" class="labeltxt"><strong><strong>Patient Name:</strong></strong></td>
                ...
                <tr>
                  ...
                  <td colspan="8" align="center" valign="top"><input type="submit" name="submit" id="submit" value='&nbsp;&nbsp;Show Report&nbsp;&nbsp;' class="inputButton btn"  />                </td>
                </tr>
              </table>
            </form></td>
        </tr>
        <tr>
          <td height="44" colspan="2" align="center"  valign="top" style="padding-bottom:50px;"><table width="100%" border="0" class="main_table11">
              ...
              <tr id="tr{$reqdetails[q].id}" bgcolor="{cycle values="#ffffff,#dfedfa"}">
                ...
                <a href="generate_edi.php?ids={$data[q].id}" title="Edit" target="_blank">Create EDI Form</a></td>
              </tr>
              {/if}
              {sectionelse}
              <tr>
