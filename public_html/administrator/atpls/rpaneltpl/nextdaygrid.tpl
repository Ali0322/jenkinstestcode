...
<tr><td style="height:10px;"></td></tr>
 ...
 &nbsp;&nbsp;&nbsp;<!--<a href="rescheduale.php?date={$date}" title="Reschedule"><img src="../images/Routing.gif" border="0" height="32" width="32" alt="Reschedule"/></a>-->{if $yes eq '1'}{if $date neq $date0}{/if}{/if}
          ...
          Driver: <select name="driver" id="driver" onChange="fsubmit('nextdaygrid.php?st={$st}&date={$date}',this.value);">
                    ...
                    {/section}  
                                  ...
                                  Client: <select  onchange="fsubmit2('nextdaygrid.php?st={$st}&date={$date}',this.value);" name="user" id="user">
                                    <option value="">Select Client</option>
                    {section name=d loop=$userdata}	
                   <option value="{$userdata[d].trip_user}" >{$userdata[d].trip_user}</option>
                    {/section}  
                                  </select>
                                  Accounts: <select name="account" id="account"  onchange="fsubmit3('nextdaygrid.php?st={$st}&date={$date}',this.value);">
              ...
              <tr>
                <td height="19" align="center" class="admintopheading">ROUTING SHEET DETAILS <span style="color:#F00; font-weight:bold;">[ {$date|date_format} ]  </span></td>
              </tr>
              <tr>
                <td height="44" align="center"  valign="top" style=""><table width="100%" border="0" class="main_table1" cellpadding="0" cellspacing="0" >                  
					...
					<tr valign="top" id="{$membdetail[q].tdid}" {if $membdetail[q].drv_id neq ''  && $membdetail[q].drv_id neq '000000' && $membdetail[q].duplicate eq '0'} class="assign" {/if}	{if $membdetail[q].drv_id neq '' && $membdetail[q].duplicate eq '1'} class="duplicateassign" {/if} >
                      <td class="grid_content">{$membdetail[q].ccode}</td>
...
<td align="left" valign="top" id="{$membdetail[q].tdid}" class="grid_content"> 
...
{/section}
                   ...
                   {$membdetail[q].pck_add}{if $membdetail[q].pickup_instruction neq ''}<br/>[<strong>Instruction:</strong> {$membdetail[q].pickup_instruction}]{/if}{if $membdetail[q].p_phnum neq ''}<br/>[<strong>Phone #:</strong> {$membdetail[q].p_phnum}]{/if}</td>
                      ...
                      <td align="left" valign="top" class="grid_content">
                      	{$membdetail[q].org_apptime|date_format:"%H:%M"}
                      </td>
                      ...
                      <td align="left" valign="top" class="grid_icon grid_content">&nbsp;&nbsp;<a  href="edit2.php?id={$membdetail[q].reqid}&date={$date}" title="Edit" target="_blank"> <img border="0" alt="Edit" src="../graphics/edit.png"></a>&nbsp;&nbsp;			  
