...
</table>{/if}<form action="edit2.php" method="post" id="addtrip" >
...
<td valign="top"><select name="account" class="required"><option value="">Select Account</option>{section name=q loop=$accounts}

                  <option value="{$accounts[q].id}" {if $accounts[q].id eq $tripdata.0.account} selected {/if}>{$accounts[q].account_name}</option>{/section}</select>         <span style="SmallnoteTxt"> * </span>		  </td>
...
<td><input type="text" name="picklocation" id="picklocation"  class="txt_box" value="{$tripdata.0.picklocation}" size="40"  onKeyUp="searchSuggest3();"  autocomplete="off"/><div id="layer3"></div></td>
...
<td><input type="text" name="droplocation" id="droplocation"  class="txt_box" value="{$tripdata.0.droplocation}" size="40"   onKeyUp="searchSuggest4();"  autocomplete="off"/><div id="layer4"></div></td>
...
<td><input type="text" name="backtolocation" id="backtolocation"  class="txt_box" value="{$tripdata.0.backtolocation}" size="40"   onKeyUp="searchSuggest7();"  autocomplete="off"/><div id="layer7"></div>
