...
<td height="19" align="center">&nbsp;</td>
 ...
 <tr>
    <td colspan="2" width="29%" height="25" align="left" class="labeltxt adjust"><b>Address 2: </b><span style="color:#FF0000">*</span><br /><input name="address2" type="text" class="validate[length[0,100]]" id="address2" value="{$udata[0].address2}" size="40" maxlength="100" /></td>
  </tr> 
    <tr>
    ...
    <tr>
    <td colspan="2" width="29%" height="25" align="left" class="labeltxt adjust"><b>ZIP : </b><span style="color:#FF0000">*</span><br /><input name="zip" type="text" class="validate[required,length[0,12]]" id="zip" value="{$udata[0].zip}" size="40" maxlength="10" /></td>
  </tr>
  <tr>
