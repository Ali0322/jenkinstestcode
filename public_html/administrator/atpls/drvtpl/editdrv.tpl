...
<table  border="0" cellspacing="0" cellpadding="0" bgcolor="#FFFFFF" align="center" class="outer_table" style="margin-bottom:10px;">
  <tr>
    <td><table width="100%" border="0" cellspacing="0" cellpadding="0">
        ...
        <tr>
          <td height="44" align="center"  valign="top" style="padding-bottom:50px;"><form name="editdrv" id="editdrv" method="post" action="editdrv.php?id={$id}">
              <table width="80%" border="0" cellspacing="2" cellpadding="2" align="center" style="border:#999999 1px solid;">
			   ...
			   {/section}
                ...
                <tr><!-- onBlur="code_chk(this);" -->
                  ...
                  <td align="left"><input type="text" name="drv_code" id="drv_code" value="{$drv_code}"  class="validate[required] inputTxtField" maxlength="15"/>
              ...
              <tr>
                ...
                <!-- <tr>
                  ...
                  <td align="left" valign="top"><input type="text" name="cell_num" id="cell_num" value="{$cell_num}" class="validate[] inputTxtField" maxlength="15"  />
                    &nbsp;<span class="SmallnoteTxt"></span></td>
                </tr>
               <tr>
