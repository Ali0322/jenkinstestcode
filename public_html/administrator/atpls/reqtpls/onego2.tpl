            ...
            <td colspan="2"><form name="search" id="search" method="post" action="" >
                ...
                <table width="100%" border="0">
                  ...
                  <tr>
                    ...
                    <td><input type="text" name="clientname" id="pname" value="{$data.0.clientname}"  class="required" onKeyUp="searchSuggest();" autocomplete="off"/>
                  ...
                  <tr>
                    ...
                    <td><input type="text" name="startdate" id="startdate22" class="required" value="{$startdate}"/></td>

                    <td><strong>Till Date:</strong></td>

                    <td><input type="text" name="enddate" id="enddate22" class="required" size="32"  value="{$enddate}"/></td>
          ...
          <tr>
            ...
            <td height="44" colspan="2" align="center"  valign="top" style="padding-bottom:50px;"><div style="width:700px; border: #F00 0px solid; float:left;">
                ...
                <form name="adduser" id="adduser" method="post" action="index22.php" onSubmit="javascript:load();">
                  ...
                  <td><input name="destination_place3" type="text"  class="txt_box " id="destination_place3" value="{$data.0.destination_place3}" maxlength="150" />
                  ...
                  <td></td>
                    ...
                    <tr id="three2" style="display:none">
                      ...
                      <td><input name="three_address" type="text"  class="txt_box " id="three_address" value="{$data.0.three_address}" maxlength="150" />
                  ...
                  <td><input name="stebldg3" type="text"  class="txt_box " id="stebldg3" value="{$data.0.stebldg3}" maxlength="150" />
                  ...
                  <td></td>
                    ...
                    <tr id="three4" style="display:none">
                      ...
                      <td><select id="three_state" name="three_state"  class="txt_box " />
                        ...
                        <option value="{$states[n].abbr}"{if $states[n].abbr eq $data.0.three_state} selected="selected" {else}{if $states[n].abbr eq 'AZ'} selected="selected" {/if}{/if}>
                    ...
                    <tr id="three5" style="display:none" >
                      ...
                      <td><input name="three_zip" type="text"  class="txt_box " id="three_zip" value="{$data.0.three_zip}" maxlength="10" />
                  ...
                  <td><input name="destination_place4" type="text"  class="txt_box " id="destination_place4" value="{$data.0.destination_place4}" maxlength="150" />
                  ...
                  <td></td>
                    ...
                    <tr id="four2" style="display:none">
                      ...
                      <td><input name="four_address" type="text"  class="txt_box " id="four_address" value="{$data.0.four_address}" maxlength="150" />
                  ...
                  <td><input name="stebldg4" type="text"  class="txt_box " id="stebldg4" value="{$data.0.stebldg4}" maxlength="150" />
                  ...
                  <td></td>
                    ...
                    <tr id="four4" style="display:none">
                      ...
                      <td><select id="four_state" name="four_state"  class="txt_box " />
                        ...
                        <option value="{$states[n].abbr}"{if $states[n].abbr eq $data.0.four_state} selected="selected" {else}{if $states[n].abbr eq 'AZ'} selected="selected" {/if}{/if}>
                    ...
                    <tr id="four5" style="display:none" >
                      ...
                      <td><input name="four_zip" type="text"  class="txt_box " id="four_zip" value="{$data.0.four_zip}" maxlength="10" />
                    ...
                    <tr id="five1" style="display:none">
                      ...
                      <td colspan="2"><input type="text" name="five_pickup" id="five_pickup" value="{$data.0.five_pickup}"  class="txt_box " maxlength="5" onBlur="javascript: time(this.id);" />
                    ...
                    <select class="" name="am_pm5" id="am_pm5"  >
                      ...
                      <option value="pm">pm</option>
                        ...
                        <input type="checkbox" name="five_will_call" id="five_will_call" onClick="check_check5();" {if $data.0.five_will_call eq 'on'} checked="checked" {/if} /></td>
                  ...
                  <td><input name="destination_place5" type="text"  class="txt_box " id="destination_place5" value="{$data.0.destination_place5}" maxlength="150" />
                  ...
                  <td></td>
                    ...
                    <tr id="five2" style="display:none">
                      ...
                      <td><input name="five_address" type="text"  class="txt_box " id="five_address" value="{$data.0.five_address}" maxlength="150" />
                  ...
                  <td><input name="stebldg5" type="text"  class="txt_box " id="stebldg5" value="{$data.0.stebldg5}" maxlength="150" />
                  ...
                  <td></td>
                    ...
                    <tr id="five4" style="display:none">
                      ...
                      <td><select id="five_state" name="five_state"  class="txt_box " />
                        ...
                        <option value="{$states[n].abbr}"{if $states[n].abbr eq $data.0.five_state} selected="selected" {else}{if $states[n].abbr eq 'AZ'} selected="selected" {/if}{/if}>
                    ...
                    <tr id="five5" style="display:none" >
                      ...
                      <td><input name="five_zip" type="text"  class="txt_box " id="five_zip" value="{$data.0.five_zip}" maxlength="10" />
                    ...
                    <tr>
                      ...
                      <td colspan="3"><table width="100%" border="0">
                          ...
                          <tr>
                            ...
                            <td><input  name="aptmonday" id="aptmonday" type="text" class="appt_txtbox" size="15" maxlength="5" onBlur="return tValid(this.value,'aptmonday');" {if $Mondaycheck eq '1'} value="{$data.0.apptime}" {else}disabled="disabled"{/if}/></td>

                            <td><input  name="retmonday" id="retmonday" type="text" class="appt_txtbox" size="15" maxlength="5" onBlur="return tValid(this.value,'retmonday');" {if $Mondaycheck eq '1'} value="{$data.0.returnpickup}" {else}disabled="disabled"{/if}/></td>
                          ...
                          <tr>
                            ...
                            <td><input  name="apttuseday" id="apttuseday" type="text" class="appt_txtbox" size="15" maxlength="5" onBlur="return tValid(this.value,'apttuseday');" {if $Tuesdaycheck eq '1'} value="{$data.0.apptime}" {else}disabled="disabled"{/if}/></td>

                            <td><input  name="rettuseday" id="rettuseday" type="text" class="appt_txtbox" size="15" maxlength="5" onBlur="return tValid(this.value,'rettuseday');" {if $Tuesdaycheck eq '1'} value="{$data.0.returnpickup}" {else}disabled="disabled"{/if}/></td>
                          ...
                          <tr>
                            ...
                            <td><input  name="aptwednesday" id="aptwednesday" type="text" class="appt_txtbox" size="15" maxlength="5" onBlur="return tValid(this.value,'aptwednesday');" {if $Wednesdaycheck eq '1'} value="{$data.0.apptime}" {else}disabled="disabled"{/if}/></td>

                            <td><input  name="retwednesday" id="retwednesday" type="text" class="appt_txtbox" size="15" maxlength="5" onBlur="return tValid(this.value,'retwednesday');" {if $Wednesdaycheck eq '1'} value="{$data.0.returnpickup}" {else}disabled="disabled"{/if}/></td>
                          ...
                          <tr>
                            ...
                            <td><input  name="aptthirsday" id="aptthirsday" type="text" class="appt_txtbox" size="15" maxlength="5" onBlur="return tValid(this.value,'aptthirsday');" {if $Thursdaycheck eq '1'} value="{$data.0.apptime}" {else}disabled="disabled"{/if}/></td>

                            <td><input  name="retthirsday" id="retthirsday" type="text" class="appt_txtbox" size="15" maxlength="5" onBlur="return tValid(this.value,'retthirsday');" {if $Thursdaycheck eq '1'} value="{$data.0.returnpickup}" {else}disabled="disabled"{/if}/></td>
                          ...
                          <tr>
                            ...
                            <td><input  name="aptfriday" id="aptfriday" type="text" class="appt_txtbox" size="15" maxlength="5" onBlur="return tValid(this.value,'aptfriday');" {if $Fridaycheck eq '1'} value="{$data.0.apptime}" {else}disabled="disabled"{/if}/></td>

                            <td><input  name="retfriday" id="retfriday" type="text" class="appt_txtbox" size="15" maxlength="5" onBlur="return tValid(this.value,'retfriday');" {if $Fridaycheck eq '1'} value="{$data.0.returnpickup}" {else}disabled="disabled"{/if}/></td>
                          ...
                          <tr>
                            ...
                            <td><input  name="aptsaturday" id="aptsaturday" type="text" class="appt_txtbox" size="15" maxlength="5" onBlur="return tValid(this.value,'aptsaturday');" {if $Saturdaycheck eq '1'} value="{$data.0.apptime}" {else}disabled="disabled"{/if}/></td>

                            <td><input  name="retsaturday" id="retsaturday" type="text" class="appt_txtbox" size="15" maxlength="5" onBlur="return tValid(this.value,'retsaturday');" {if $Saturdaycheck eq '1'} value="{$data.0.returnpickup}" {else}disabled="disabled"{/if}/></td>
                          ...
                          <tr>
                            ...
                            <td><input  name="aptsunday" id="aptsunday" type="text" class="appt_txtbox" size="15" maxlength="5" onBlur="return tValid(this.value,'aptsunday');" {if $Sundaycheck eq '1'} value="{$data.0.apptime}" {else}disabled="disabled"{/if}/></td>

                            <td><input  name="retsunday" id="retsunday" type="text" class="appt_txtbox" size="15" maxlength="5" onBlur="return tValid(this.value,'retsunday');" {if $Sundaycheck eq '1'} value="{$data.0.returnpickup}" {else}disabled="disabled"{/if}/></td>
