  ...
  if(!$error) {
		...
		$Query  = "UPDATE ".TBL_HOSPITALS." SET 
		 ...
		 if($oustatus == 'inactive' || $oustatus == 'disapproved'){
			...
			$subject = 'Congratulations, your request for new account is approved -- Midnimo Medical Transportationation';
        ...
        TEL:'.$emaildata[0]['phone'].'</font></strong></td>
						  ...
						  <tr>
							...
							Your request for a new account on Midnimo Medical Transportation
		 ...
		 if($oustatus == 'inactive' || $oustatus == 'approved'){
			  ...
			  $from = $emaildata[0]['email'];
			   $subject = 'Request for new account on Midnimo Medical Transportation is diapproved';
    	       $body    = '<table width="50%" border="0" cellspacing="2" cellpadding="2">
						  <tr>
							<td width="63%"><a href="http://'.$emaildata[0]['url'].'"><img src="http://'.$emaildata[0]['url'].'/'.$emaildata[0]['image'].'" border="0" /></a></td>
							<td width="37%"><strong>
        ...
        TEL:'.$emaildata[0]['phone'].'</font></strong></td>
		 ...
		 if($oustatus == 'disapproved' || $oustatus == 'approved'){
			  ...
			  $from = $emaildata[0]['email'];
			   $subject = 'Your account on Midnimo Medical Transportation is Inactive now';
    	       $body    = '<table width="50%" border="0" cellspacing="2" cellpadding="2">
						  <tr>
							<td width="63%"><a href="http://'.$emaildata[0]['url'].'"><img src="http://'.$emaildata[0]['url'].'/'.$emaildata[0]['image'].'" border="0" /></a></td>
							<td width="37%"><strong>
    ...
    $pgTitle = "Admin Panel -- Hospital/Clinic [Edit]";
