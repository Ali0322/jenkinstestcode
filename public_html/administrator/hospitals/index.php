...
// Fetch all categories list
	...
	$Query = "SELECT * FROM ".TBL_HOSPITALS." WHERE `Status`='".$st."'  ORDER BY `firstname` ASC LIMIT $offset, $limit";
	$Query2 = "SELECT * FROM ".TBL_HOSPITALS." WHERE `Status`='".$st."'  ORDER BY `firstname` ASC";
   ...
   // Footer paging
	...
	$smarty->assign("st",$st);			
	$smarty->display('hosptpls/index.tpl');
