  ...
  if(!$error) {
		 ...
		 $Query  = "INSERT INTO ".TBL_HOSPITALS." SET 
		  ...
		  if($db->execute($Query))
			...
			$subject = 'Congratulations, your request for new account is approved -- Midnimo Medical Transportation';
			...
			$body    = '<table width="50%" border="0" cellspacing="2" cellpadding="2">
						  ...
						  <tr>
							...
							Your request for a new account on Midnimo Medical Transportation has been approved successfully .<br>
							You can now <a href="http://www.hybriditservices.com/demos/midnimo_transportation/login.php">login</a> to submit trip requests with following credentials:.<br> 
						  ...
						  <tr>
							<td colspan="2" align="left">Regards! <br> Midnimo Medical Transportation Support Team!</td>
						  </tr>
						</table>';
    ...
    $pgTitle = "Admin Panel -- Hospital/Clinic [Add]";	
