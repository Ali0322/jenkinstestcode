...
{*/
...

	{
		...
		$queryRestore = " Update ".TBL_ACCNTTYPES." SET
		...
		{  
			...
			echo "<script>alert('Type Restored!');</script>";

			echo "<script>location.href= 'accnt_trash.php';</script>";
...

	{
		...
		$QueryDel = "DELETE FROM ".TBL_ACCNTTYPES." WHERE id='".$_GET['delId']."'";
...
//}
...

	{
	 ...
	 $Querypg = "SELECT COUNT(*) FROM ".TBL_ACCNTTYPES." Where del = '1'  $whr" ;	
	...
	$Query2 = "SELECT * FROM ".TBL_ACCNTTYPES." Where del = '1'  $whr LIMIT ".$pagination->startRow . ",".$pagination->maxRows;
	...
	$smarty->display('hosptpls/accnttype_trash.tpl');
