 ...
 if(isset($_POST['submit'])){
	  ...
	  $ustatus   = sql_replace($_POST['ustatus']);	
       ...
       if(!isset($hospid) || $hospid == ''){
		   $error .= "<img src='images/bulit.gif'> Corporation not selected!</img><br>";
		   }
  ...
  if(!$error) {
		 ...
		 $Query  = "INSERT INTO ".TBL_CM." SET 
		  ...
		  if($db->execute($Query))
		    { 
			  echo '<script>alert("Casmanager Added Successfully.");</script>';
    ...
    $pgTitle = "Admin Panel -- [Add Case Manager]";	
