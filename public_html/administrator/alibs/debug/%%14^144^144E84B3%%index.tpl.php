<?php /* Smarty version 2.6.12, created on 2019-12-13 18:01:37
        ...
        <tr>
          <td align="center"  valign="top"><table width="100%" border="0" class="main_table">
              <tr>
                ...
                <td width="25%" align="center" class="label_txt_heading"><strong>Assigned Vehicle</strong></td>
                <td width="10%" align="center" class="label_txt_heading"><strong>UnAssigned</strong></td>
                <td width="25%" align="center" class="label_txt_heading"><strong>Change Assigned Vehicle</strong></td>
              </tr>
...
');" ><img alt="Un-Assign" border="0"  src="../images/icons/cross.png"></a><?php endif; ?></td>
                <td align="center" valign="middle"><select name="vtype" id="vtype" class="SelectBox required" onchange="return dvmap(this.value,'<?php echo $this->_tpl_vars['drvdetails'][$this->_sections['q']['index']]['Drvid']; ?>
')" >
...
" <?php if ($this->_tpl_vars['vlist'][$this->_sections['n']['index']]['id'] == $this->_tpl_vars['vtype']): ?>selected<?php endif; ?>><?php echo $this->_tpl_vars['vlist'][$this->_sections['n']['index']]['vnumber']; ?>
