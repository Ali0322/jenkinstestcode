<?php /* Smarty version 2.6.12, created on 2021-02-02 13:46:11
         compiled from mercytpl/add.tpl */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('modifier', 'date_format', 'mercytpl/add.tpl', 2592, false),)), $this); ?>
  ...
  <tr>
    ...
    <td><table width="100%" border="0" cellspacing="0" cellpadding="0">
        ...
        <tr> 
		  ...
		  <a href="add_trip_sheet.php" rel="facebox" >MTM
...
<a href="add_trip_sheet3.php" rel="facebox" >Access2Care
		  ...
		  <img alt="Add" border="0" src="../graphics/add_xlsx.png" title="Upload Trips Sheet"></a>-->
          <a href="virg_trip_sheet.php" rel="facebox">Virg Trip Sheet
            <img alt="Add" src="../graphics/add_xlsx.png" title="Upload Trips Sheet" border="0"></a> |
            
            
            
          <a href="add_trip_sheet2.php" rel="facebox">Logistic Care
            <img alt="Add" src="../graphics/add_xlsx.png" title="Upload Trips Sheet" border="0"></a> |
          <a href="southeast.php" rel="facebox"> South East Trans <img alt="Add" border="0" src="../graphics/csv.png" title="Upload Trips Sheet" width="32" height="32"></a> | 
          <!--<a href="translink.php" rel="facebox"> Trans Link <img alt="Add" border="0" src="../graphics/csv.png" title="Upload Trips Sheet" width="32" height="32"></a> 
           |--> 
...
function check_cecc(){
	...
	if($(\'#check_recc\').attr(\'checked\')){ $(\'#recc\').show(); }else { $(\'#recc\').hide(); }
                ...
                <tr>
                  ...
                  <td colspan="2" align="right"><input type="submit" name="submit" value="Submit" class="inputButton btn"  />
