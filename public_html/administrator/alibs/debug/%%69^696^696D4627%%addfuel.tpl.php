<?php /* Smarty version 2.6.12, created on 2020-08-08 07:30:31
         compiled from vehtpl/addfuel.tpl */ ?>
<?php echo '
...
<table width="100%" border="0" align="center" cellpadding="4" cellspacing="0">
 ...
 <?php endif; ?> </td>
  ...
  <tr>
	...
	<form name="addfuel" id="addfuel" method="post" action="addfuel.php?id=<?php echo $this->_tpl_vars['id']; ?>
">
								...
								<table width="650" border="0" cellspacing="2" cellpadding="2">
								  ...
								  <tr>
								    ...
								    <td height="25"><input type="text" name="rfdate" id="rfdate" value="<?php echo $this->_tpl_vars['rfdate']; ?>
" class="validate[required] inputTxtField date" onblur="chk_date();" /> 
								  ...
								  <tr>
								    ...
								    <td height="25"><input name="qty" type="text" class="validate[required,custom[onlyNumber]] inputTxtField digits" id="qty" value="<?php echo $this->_tpl_vars['qty']; ?>
" maxlength="2" />
								  ...
								  <tr>
									...
									<td width="74%" height="25"><input name="amt" type="text" class="validate[required,custom[onlyNumber]] inputTxtField digits" id="amt" value="<?php echo $this->_tpl_vars['amt']; ?>
" maxlength="4" /> 
