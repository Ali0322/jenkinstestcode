<?php /* Smarty version 2.6.12, created on 2020-07-02 19:24:24
         compiled from rpaneltpl/grid2.tpl */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('function', 'cycle', 'rpaneltpl/grid2.tpl', 326, false),array('modifier', 'date_format', 'rpaneltpl/grid2.tpl', 373, false),)), $this); ?>
...
function st_status_change(id,st){ 
	ok=confirm("Are you sure you want to change status of this Trip?");
		if (ok)
		{ //alert(st);		
	 $.post("editgrid_ajax.php", {id: ""+id,st: ""+st}, function(data){
 ...
 <?php endif; ?></span></td>
              ...
              <tr>
                <td height="19" align="center"><div id="search_form">
                    <form name="searchReport" action="grid2.php?id=<?php echo $this->_tpl_vars['id']; ?>
                        ...
                        <tr>
                          <td colspan="8" align="left" valign="middle" class="labeltxt"><table border="0" width="100%">
                              <tr>
                                ...
                                <td rowspan="2"  align="left" valign="top" class="labeltxt"><select name="driver" id="driver" onchange="fsubmit('grid2.php?id=<?php echo $this->_tpl_vars['id']; ?>
&st=<?php echo $this->_tpl_vars['st']; ?>
&ad=<?php echo $this->_tpl_vars['ad']; ?>
',this.value);">
...
" <?php if ($this->_tpl_vars['drivers'][$this->_sections['d']['index']]['drv_code'] == $this->_tpl_vars['drv']): ?> selected="selected" <?php endif; ?>><?php echo $this->_tpl_vars['drivers'][$this->_sections['d']['index']]['fname']; ?>
 ...
 - [ <?php echo $this->_tpl_vars['drivers'][$this->_sections['d']['index']]['drv_code']; ?>
                    ...
                    <?php endfor; endif; ?>  
                                ...
                                <td align="left" valign="top" class="labeltxt"><select  onchange="fsubmit2('grid2.php?id=<?php echo $this->_tpl_vars['id']; ?>
&st=<?php echo $this->_tpl_vars['st']; ?>
&ad=<?php echo $this->_tpl_vars['ad']; ?>
...
" class="inputTxtField "/>--> 
                                ...
                                <td rowspan="2" align="left" valign="top" class="labeltxt"><select name="account" id="account"  onchange="fsubmit3('grid2.php?id=<?php echo $this->_tpl_vars['id']; ?>
&st=<?php echo $this->_tpl_vars['st']; ?>
&ad=<?php echo $this->_tpl_vars['ad']; ?>
',this.value);">
...
" class="inputTxtField date" />-->
              ...
              <tr>
                <td class="tabs"><ul>
                    <li <?php if ($this->_tpl_vars['st'] == '9'): ?> class="active"<?php endif; ?>><a href="grid2.php?id=<?php echo $this->_tpl_vars['id']; ?>
&st=9&acknowledge_status=0">Pending (<?php echo $this->_tpl_vars['st9']; ?>
)</a></li>
                    <li <?php if ($this->_tpl_vars['st'] == '5'): ?> class="active"<?php endif; ?>><a href="grid2.php?id=<?php echo $this->_tpl_vars['id']; ?>
&st=5">In Progress (<?php echo $this->_tpl_vars['st5']; ?>
)</a></li>
                    <li <?php if ($this->_tpl_vars['st'] == '10'): ?> class="active"<?php endif; ?>><a href="grid2.php?id=<?php echo $this->_tpl_vars['id']; ?>
&st=10">Arrived (<?php echo $this->_tpl_vars['st10']; ?>
)</a></li>
                    <li <?php if ($this->_tpl_vars['st'] == '6'): ?> class="active"<?php endif; ?>><a  href="grid2.php?id=<?php echo $this->_tpl_vars['id']; ?>
&st=6">Picked Up (<?php echo $this->_tpl_vars['st6']; ?>
)</a></li>
                    <li <?php if ($this->_tpl_vars['st'] == '4'): ?> class="active"<?php endif; ?>><a href="grid2.php?id=<?php echo $this->_tpl_vars['id']; ?>
&st=4&ad=0">Delivered (<?php echo $this->_tpl_vars['st4']; ?>
)</a></li>
                    <li <?php if ($this->_tpl_vars['st'] == '3'): ?> class="active"<?php endif; ?>><a href="grid2.php?id=<?php echo $this->_tpl_vars['id']; ?>
&st=3&ad=0">Cancelled (<?php echo $this->_tpl_vars['st3']; ?>
                    ...
                    <a href="grid2.php?id=<?php echo $this->_tpl_vars['id']; ?>
...
&type=<?php if ($this->_tpl_vars['st'] == 6): ?>1<?php else: ?>2<?php endif; ?>');" title="Edit"> <img border="0" alt="Edit" src="../graphics/edit.png"></a>--><a  href="edit2.php?id=<?php echo $this->_tpl_vars['membdetail'][$this->_sections['q']['index']]['reqid']; ?>
...
')" ><img src="../graphics/alert.png" height="20px" width="20px" /></a><br/>
...
',this.value);" style="width:120px;" >
 <?php if ($this->_tpl_vars['membdetail'][$this->_sections['q']['index']]['status'] == '5' || $this->_tpl_vars['membdetail'][$this->_sections['q']['index']]['status'] == '2' || $this->_tpl_vars['membdetail'][$this->_sections['q']['index']]['status'] == '0'): ?>                       
                          <option value="5" <?php if ($this->_tpl_vars['membdetail'][$this->_sections['q']['index']]['status'] == '5'): ?> selected="selected"<?php endif; ?>>In Progress</option>
                          <option value="2" <?php if ($this->_tpl_vars['membdetail'][$this->_sections['q']['index']]['status'] == '2'): ?> selected="selected"<?php endif; ?>>Rescheduled</option>
                          ...
                          <option value="8" <?php if ($this->_tpl_vars['membdetail'][$this->_sections['q']['index']]['status'] == '8'): ?> selected="selected"<?php endif; ?>>Not Going</option>
                          <option value="7" <?php if ($this->_tpl_vars['membdetail'][$this->_sections['q']['index']]['status'] == '7'): ?> selected="selected"<?php endif; ?>>Not at home</option>
<?php elseif ($this->_tpl_vars['membdetail'][$this->_sections['q']['index']]['status'] == '3'): ?>	
                          <option value="5" <?php if ($this->_tpl_vars['membdetail'][$this->_sections['q']['index']]['status'] == '5'): ?> selected="selected"<?php endif; ?>>In Progress</option>
                          <option value="3" <?php if ($this->_tpl_vars['membdetail'][$this->_sections['q']['index']]['status'] == '3'): ?> selected="selected"<?php endif; ?>>Cancelled</option>
<?php elseif ($this->_tpl_vars['membdetail'][$this->_sections['q']['index']]['status'] == '6'): ?>
                          <option value="5" <?php if ($this->_tpl_vars['membdetail'][$this->_sections['q']['index']]['status'] == '5'): ?> selected="selected"<?php endif; ?>>Picked Up</option>
...
<?php elseif ($this->_tpl_vars['membdetail'][$this->_sections['q']['index']]['status'] == '7'): ?>	
                          <option value="5" <?php if ($this->_tpl_vars['membdetail'][$this->_sections['q']['index']]['status'] == '5'): ?> selected="selected"<?php endif; ?>>In Progress</option>
                          <option value="7" <?php if ($this->_tpl_vars['membdetail'][$this->_sections['q']['index']]['status'] == '7'): ?> selected="selected"<?php endif; ?>>Not at home</option>
<?php elseif ($this->_tpl_vars['membdetail'][$this->_sections['q']['index']]['status'] == '8'): ?>	
                          <option value="5" <?php if ($this->_tpl_vars['membdetail'][$this->_sections['q']['index']]['status'] == '5'): ?> selected="selected"<?php endif; ?>>In Progress</option>
                          <option value="8" <?php if ($this->_tpl_vars['membdetail'][$this->_sections['q']['index']]['status'] == '8'): ?> selected="selected"<?php endif; ?>>Not Going</option>
