<?php /* Smarty version 2.6.12, created on 2021-02-02 13:15:18
         compiled from mercytpl/translink.tpl */ ?>
<?php echo ' 
...
<form name="addcsv" id="addcsv" method="post" action="translink.php" enctype="multipart/form-data" onsubmit="return validate(this);" >
 ...
 <?php endif; ?> </td>
    ...
    <tr>
      <td class="admintopheading" style="text-align:center;">Upload Trips Sheet </td>
    </tr>
    <tr>
            ...
            <td align="left" valign="top" width="100%"><table width="650" border="0" cellspacing="2" cellpadding="2">
                <tr>
                  ...
                  <td height="25"><input type="file" name="file_csv" id="file_csv" class="required" />
                    <span style="color:#FF0000"> * (.xls only)</span></td>
                </tr>
               <!-- <tr>
