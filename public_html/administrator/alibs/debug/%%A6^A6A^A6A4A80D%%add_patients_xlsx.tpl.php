<?php /* Smarty version 2.6.12, created on 2022-02-23 16:38:12
         compiled from patientstpls/add_patients_xlsx.tpl */ ?>
<?php echo ' 
...
if((document.addcsv.file_csv.value.lastIndexOf(".xls")==-1)) {    
...
<form name="addcsv" id="addcsv" method="post" action="add_patients_xlsx.php" enctype="multipart/form-data" onsubmit="return validate(this);" >
 ...
 <?php endif; ?> </td>
    ...
    <tr>
      <td class="admintopheading">Add Patients Data Through .xlsx formate </td>
    </tr>
    <tr>
      <td align="left" valign="top"><table width="650" border="0" cellspacing="0" cellpadding="0" align="center">
          ...
          <tr>
            ...
            <td align="left" valign="top" width="100%"><table width="650" border="0" cellspacing="2" cellpadding="2">
                <tr>
                  <td height="25" align="right" class="labeltxt"><strong>Upload XLSX Sheet:</strong></td>
                  <td height="25"><input type="file" name="file_csv" id="file_csv" class="required" />
                    <span style="color:#FF0000"> *  (.xlsx format only)</span></td>
                </tr>
                <!--<tr>
                ...
                <tr>
                  <td height="25">&nbsp;</td>
                  <td height="25"><input class="btn" type="submit" value="Upload" name="addListing"/>
