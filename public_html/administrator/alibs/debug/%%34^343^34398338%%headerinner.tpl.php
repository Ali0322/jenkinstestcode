<?php /* Smarty version 2.6.12, created on 2020-09-23 19:03:01
         compiled from headerinner.tpl */ ?>
...
<div class="banner_menu float_right">
            ...
            <div class="logo float_left">
				<img src="../images/logo.png" style="max-width:150px;max-height:70px;" alt="" />
            </div><!-- end of logo-->
<div class="message-text" style="font-size: 12px;  text-align: center; width: 1000px; line-height: 23px; padding-top: 4px; color:#F00;">
            ...
            <?php echo $_SESSION['general_message']; ?>
...
<!-- start of left side bar -->
    ...
    <!--    <p class="menu_head">CMS</p>
        ...
        <a href="../reports/revenue_payment.php">Revenue & Payment</a><?php endif; ?>
...
<!--         <a href="../reports/rep_mtm.php">MTM Billing Report</a>
 -->        
 		<a href="../reports/rep_mtm.php">MTM Trip Log</a>
 		<!-- <a href="../reports/rep_nmt.php">National MedTrans Trip Log</a> -->
