<?php /* Smarty version 2.6.12, created on 2019-12-26 18:18:02
         compiled from drvtpl/editdrv.tpl */ ?>
...
<table  border="0" cellspacing="0" cellpadding="0" bgcolor="#FFFFFF" align="center" class="outer_table" style="margin-bottom:10px;">
  <tr>
    <td><table width="100%" border="0" cellspacing="0" cellpadding="0">
        ...
        <tr>
          <td height="44" align="center"  valign="top" style="padding-bottom:50px;"><form name="editdrv" id="editdrv" method="post" action="editdrv.php?id=<?php echo $this->_tpl_vars['id']; ?>
">
...
"  class="validate[required] inputTxtField" maxlength="15"/>
                    <input name="d_code_x" type="hidden" id="d_code_x" value="<?php echo $this->_tpl_vars['drv_code']; ?>
" />
...
" class="validate[required] inputTxtField" maxlength="11"   />
                    &nbsp;<span class="SmallnoteTxt">*</span>
                    <input type="hidden" name="hidssn" id="hidssn" value="<?php echo $this->_tpl_vars['hidssn']; ?>
" /></td>
                </tr>-->
                <tr>
                  <td align="left" valign="top" class="labels"><strong>Hourly Rate:</strong></td>
                  <td align="left"><input type="text" name="hrate" id="hrate" value="<?php echo $this->_tpl_vars['hrate']; ?>
" class="validate[] inputTxtField" maxlength="5"   />
                    &nbsp;<span class="SmallnoteTxt">($)</span>
                    <input type="hidden" name="hidssn" id="hidssn" value="<?php echo $this->_tpl_vars['hidssn']; ?>
" /></td>
                </tr>
                <tr>
                  ...
                  <td align="left"><input type="text" name="per_run" id="per_run" value="<?php echo $this->_tpl_vars['data']['per_run']; ?>
" class=" validate[] inputTxtField" maxlength="5"   />
                    &nbsp;<span class="SmallnoteTxt">($) </span></td>
                </tr>
                <tr>
                  <td align="left" valign="top" class="labels"><strong>Incentive per mile:</strong></td>
                  <td align="left"><input type="text" name="per_mile" id="per_mile" value="<?php echo $this->_tpl_vars['data']['per_mile']; ?>
" class=" validate[] inputTxtField" maxlength="5"   />
                    &nbsp;<span class="SmallnoteTxt">($) </span></td>
                </tr>
                <tr>
...
" class="validate[required] inputTxtField" maxlength="15"  /></td>
                </tr>-->
                <tr>
...
" class="validate[] inputTxtField email" maxlength="100"  />
                    ...
                    <input type="hidden" name="hidemail" id="hidemail" value="<?php echo $this->_tpl_vars['email']; ?>
" />
                    </span></td>
                </tr>
                <tr>
...
" class="validate[] inputTxtField date" maxlength="10"  onblur="age_calc(this);" />
                ...
                <!--<tr>
                  ...
                  <td align="left" valign="top"><input name="age" type="text" class="validate[required,custom[onlyNumber]] inputTxtField digits" id="age"   value="<?php echo $this->_tpl_vars['age']; ?>
...
" <?php if ($this->_tpl_vars['clist'][$this->_sections['n']['index']]['iso'] == $this->_tpl_vars['nationality']): ?> selected="selected" <?php endif; ?>> <?php echo $this->_tpl_vars['clist'][$this->_sections['n']['index']]['printable_name']; ?>
 </option>
			   <?php endfor; endif; ?>
                    </select>
                    &nbsp;</td>
...
onKeyUp="limitText(this.form.prev_addr,this.form.countdown3,100);"><?php echo $this->_tpl_vars['prev_addr']; ?>
                ...
                <tr style="">
                  ...
                  <td valign="top" align="left"><select name="drvstatus" id="drvstatus" class="validate[] SelectBox" >
                      <option value="Active" <?php if ($this->_tpl_vars['drvstatus'] == 'Active'): ?>selected<?php endif; ?>>Active</option>
                      <option value="Suspended" <?php if ($this->_tpl_vars['drvstatus'] == 'Suspended'): ?>selected<?php endif; ?>>Suspended</option>
                      <option value="Left" <?php if ($this->_tpl_vars['drvstatus'] == 'Left'): ?>selected<?php endif; ?>>Left</option>
                    </select>
                    &nbsp;<span class="SmallnoteTxt"></span></td>
                </tr>
                  <tr>
   ...
   <!-- <input type="hidden" name="drvstatus" value="<?php echo $this->_tpl_vars['drvstatus']; ?>
"  />-->
