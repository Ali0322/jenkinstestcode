<?php /* Smarty version 2.6.12, created on 2019-12-16 15:04:14
         compiled from reportstpl/details.tpl */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('modifier', 'date_format', 'reportstpl/details.tpl', 59, false),)), $this); ?>
 <?php echo '
...
<?php if ($this->_tpl_vars['data']['0']['startmilage'] != ''): ?><strong>Start Miles:</strong><?php echo $this->_tpl_vars['data']['0']['startmilage'];  endif; ?>
<?php if ($this->_tpl_vars['data']['0']['endmilage'] != ''): ?><strong>&nbsp;&nbsp;&nbsp;End Miles&nbsp;&nbsp;&nbsp;:</strong><?php echo $this->_tpl_vars['data']['0']['endmilage']; ?>
<br/><?php endif; ?>
<?php if ($this->_tpl_vars['data']['0']['paperwork'] != ''): ?><strong>Is there any paper work?&nbsp;&nbsp;&nbsp;:</strong><?php echo $this->_tpl_vars['data']['0']['paperwork']; ?>
<br/><?php endif; ?>
<?php if ($this->_tpl_vars['data']['0']['personal_belonging'] != ''): ?><strong>Are there any personal belongings?&nbsp;&nbsp;&nbsp;:</strong><?php echo $this->_tpl_vars['data']['0']['personal_belonging']; ?>
<br/><?php endif; ?>
<?php if ($this->_tpl_vars['data']['0']['medication'] != ''): ?><strong>Are there any medication?&nbsp;&nbsp;&nbsp;:</strong><?php echo $this->_tpl_vars['data']['0']['medication']; ?>
<br/><?php endif; ?>
    </div>-->
    </td>
     <td class="tdheight" colspan="2">
    <div style="float:left; padding-left:10px;">
<?php if ($this->_tpl_vars['data']['0']['signature'] != ''): ?><img src="../../iphone/signature/<?php echo $this->_tpl_vars['data']['0']['signature']; ?>
" width="140" height="140" /><?php endif; ?>
<?php if ($this->_tpl_vars['data']['0']['signature2'] != ''): ?><img src="../../iphone/signature/<?php echo $this->_tpl_vars['data']['0']['signature2']; ?>
" width="140" height="140" /><?php endif; ?>
    </div>
    </td>
  </tr>
...
<tr><td colspan="6" style="height:20px;"></td></tr>
<tr><td width="140" class="headus">Account Name:</td><td class="val"><?php echo $this->_tpl_vars['data']['0']['account_name']; ?>
</td></tr>
<tr><td width="140" class="headus">Client Name:</td><td class="val"><?php echo $this->_tpl_vars['data']['0']['clientname']; ?>
</td><td width="140" class="headus">PO #:</td><td width="140" class="val"><?php echo $this->_tpl_vars['data']['0']['po']; ?>
...
</td><td width="140" class="headus">Comments:</td><td width="140" class="val" colspan="5"><?php echo $this->_tpl_vars['data']['0']['comments']; ?>
</td>
</tr>
  <tr></tr>
    </table>
...
<tr>
              ...
              <td height="25"  align="left" class="labeltxt"><?php echo ((is_array($_tmp=$this->_tpl_vars['data']['0']['tripassign_time'])) ? $this->_run_mod_handler('date_format', true, $_tmp, "%H:%M:%S") : smarty_modifier_date_format($_tmp, "%H:%M:%S")); ?>
 [ <?php echo ((is_array($_tmp=$this->_tpl_vars['data']['0']['tripassign_time'])) ? $this->_run_mod_handler('date_format', true, $_tmp) : smarty_modifier_date_format($_tmp)); ?>
              ...
              <td height="25"  align="left" class="labeltxt"><?php echo ((is_array($_tmp=$this->_tpl_vars['data']['0']['driverconfirm_time'])) ? $this->_run_mod_handler('date_format', true, $_tmp, "%H:%M:%S") : smarty_modifier_date_format($_tmp, "%H:%M:%S")); ?>
</td>
            </tr>
            <tr>
              <td height="25"  align="left" class="labeltxt">Driver Arrival Time: </td>
              <td height="25"  align="left" class="labeltxt"><?php echo ((is_array($_tmp=$this->_tpl_vars['data']['0']['arrived_time'])) ? $this->_run_mod_handler('date_format', true, $_tmp, "%H:%M:%S") : smarty_modifier_date_format($_tmp, "%H:%M:%S")); ?>
</td>
            ...
            <tr>
              ...
              <td height="25"  align="left" class="labeltxt"><?php echo $this->_tpl_vars['data'][0]['pck_time']; ?>
</td>
              <td height="25"  align="left" class="labeltxt">Actual Picked Time: </td>
              <td height="25"  align="left" class="labeltxt"><?php echo $this->_tpl_vars['data'][0]['aptime']; ?>
</td>
            </tr>
            <tr>
            ...
            <tr>
              ...
              <td height="25"   align="left" class="labeltxt"><?php echo $this->_tpl_vars['data'][0]['drp_time']; ?>
</td>
              <td height="25"   align="left" class="labeltxt">Actual Dropped Time: </td>
              <td height="25"  align="left" class="labeltxt"><?php echo $this->_tpl_vars['data'][0]['drp_atime']; ?>
</td>
            </tr>
            <tr>
...
?> <img width="15px;" src="../theme/rate.gif"/> <?php endfor; endif; ?>
       ...
       <!--     <tr>
            ...
            <!--<tr>
              <td height="25"   align="left" class="labeltxt">Temporary Comments:</td>
              <td height="25"  align="left" class="labeltxt" colspan="3"><?php echo $this->_tpl_vars['data']['0']['temp_comments']; ?>
</td>
            </tr>-->
            ...
            <tr>
              ...
              <td height="25"   align="left" class="labeltxt" >
                ...
                <?php if ($this->_tpl_vars['data'][0]['status'] == '2'): ?>Reschedule<?php endif; ?>
