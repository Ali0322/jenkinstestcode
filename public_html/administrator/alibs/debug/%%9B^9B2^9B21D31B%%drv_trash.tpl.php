<?php /* Smarty version 2.6.12, created on 2022-02-23 14:57:24
         compiled from drvtpl/drv_trash.tpl */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('function', 'cycle', 'drvtpl/drv_trash.tpl', 83, false),)), $this); ?>
...
function deleteRec(id)
		...
		ok=confirm("Are you sure you want to delete this Driver?");

		if (ok)

		{ location.href="drv_trash.php?delId="+id;
...
function restore(id)
		...
		{ location.href="drv_trash.php?resid="+id;
...
<table id="table1" class="outer_table"   border="0" cellspacing="0" cellpadding="0" align="center" bgcolor="#FFFFFF" style="margin-bottom:10px;">
 ...
 <?php endif; ?></td>
      ...
      <tr>
        <td height="19" align="center" class="admintopheading">DRIVERS TRASH </td>
        </tr>
      <tr>
        <td height="44" align="center"  valign="top"><table width="100%" border="0" class="main_table">
                  ...
                  <tr align="center">
                    ...
                    <td class="label_txt_heading"><strong>Driver Name</strong></td>

                    <td width="20%" class="label_txt_heading"><strong>Deleted Date</strong></td>
...
.</b></td>
                    ...
                    <td align="center" valign="middle"><?php echo $this->_tpl_vars['vehtypedetails'][$this->_sections['q']['index']]['fname']; ?>
 <?php echo $this->_tpl_vars['vehtypedetails'][$this->_sections['q']['index']]['fname']; ?>
</td>
					...
					<a href="#" title="Restore Driver Type"  onClick="return restore('<?php echo $this->_tpl_vars['vehtypedetails'][$this->_sections['q']['index']]['Drvid']; ?>
');"> 

					<img border="0" alt="Restore" src="../graphics/restore.png"></a>&nbsp;&nbsp;

                    <a href="#" onClick="return deleteRec('<?php echo $this->_tpl_vars['vehtypedetails'][$this->_sections['q']['index']]['Drvid']; ?>
');" title="Remove"> 
