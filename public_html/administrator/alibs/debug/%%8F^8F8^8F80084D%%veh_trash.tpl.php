<?php /* Smarty version 2.6.12, created on 2022-02-23 14:57:36
         compiled from vehtpl/veh_trash.tpl */ ?>
...
function deleteRec(id)
		...
		{ location.href="veh_trash.php?delId="+id;
...
function restore(id)
		...
		{ location.href="veh_trash.php?resid="+id;
...
<table id="table1" class="outer_table"   border="0" cellspacing="0" cellpadding="0" align="center" bgcolor="#FFFFFF" style="margin-bottom:10px; width:720px;">
 ...
 <?php endif; ?></td>
      ...
      <tr>
        ...
        <td height="19" align="center"><div align="right" id="add_div" style="padding-right:20px; padding-bottom:5px;"> [<a href="javascript:history.back();">Back</a>]<!--&nbsp;|&nbsp;<a title="Add Vehicle Type" href="addvehtype.php" rel="facebox"><img alt="Add" border="0" src="../graphics/add_12.gif"></a> --></div></td>
      ...
      <tr>
        ...
        <td height="19" align="center" class="admintopheading">VEHICLES TRASH</td>
      ...
      <tr>
        ...
        <td height="44" align="center"  valign="top" style="padding-bottom:50px;"><table width="100%" border="0" class="main_table">
                  ...
                  <tr align="center">
                    ...
                    <td class="label_txt_heading"><strong>Name</strong></td>



                    <td width="15%" class="label_txt_heading"><strong>Deleted Date</strong></td>



                    <td width="25%" class="label_txt_heading"><strong>Deleted By</strong></td>
...
.</b></td>
                    ...
                    <td align="center" valign="middle"><?php echo $this->_tpl_vars['vehtypedetails'][$this->_sections['q']['index']]['vname']; ?>
</td>
					...
					<a href="#" title="Restore Vehicle "  onClick="return restore('<?php echo $this->_tpl_vars['vehtypedetails'][$this->_sections['q']['index']]['id']; ?>
');"> 
