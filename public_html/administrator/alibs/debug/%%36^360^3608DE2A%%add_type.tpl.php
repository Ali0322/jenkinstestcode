<?php /* Smarty version 2.6.12, created on 2020-09-29 12:20:34
         compiled from mntncetpl/add_type.tpl */ ?>
<?php echo '
	...
	<form name="addtype" id="frm_addtype" method="post" action="add_type.php">
								...
								<table width="650" border="0" cellspacing="2" cellpadding="2">
								  ...
								  <tr>
									...
									<td width="74%" height="25"><input name="mentype" type="text" class="validate[required,custom[onlyLetter]] inputTxtField" id="mentype" value="<?php echo $this->_tpl_vars['vehtype']; ?>
" maxlength="50" />
