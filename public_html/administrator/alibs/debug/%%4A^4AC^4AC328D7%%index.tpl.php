<?php /* Smarty version 2.6.12, created on 2022-02-23 14:56:42
         compiled from ccode/index.tpl */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('function', 'cycle', 'ccode/index.tpl', 42, false),)), $this); ?>
...
<table id="table1" class="outer_table"   border="0" cellspacing="0" cellpadding="0" align="center" bgcolor="#FFFFFF" style="margin-bottom:10px;">
 ...
 <?php endif; ?></span></td>
              ...
              <tr>  <td height="19" align="center" class="admintopheading">COMPANY CODE MANAGEMENT</td>   </tr>
              <tr>
                <td height="44" align="center"  valign="top" style="padding-bottom:20px;"><table width="100%" border="0" class="main_table">
                    <tr>
                      ...
                      <td width="60%" align="left" class="label_txt_heading"><strong>Company</strong></td>
                      <td width="25%" align="left" class="label_txt_heading"><strong>Code</strong></td>
...
">
                      ...
                      <td align="left" valign="middle"><?php echo $this->_tpl_vars['admdetail'][$this->_sections['q']['index']]['company']; ?>
</td>
                      <td align="left" valign="middle"><?php echo $this->_tpl_vars['admdetail'][$this->_sections['q']['index']]['code']; ?>
</td>
