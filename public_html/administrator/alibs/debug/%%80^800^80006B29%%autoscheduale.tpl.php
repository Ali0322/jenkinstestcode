<?php /* Smarty version 2.6.12, created on 2020-05-20 18:55:33
         compiled from rpaneltpl/autoscheduale.tpl */ ?>
...
var noftrips = \'';  echo $this->_tpl_vars['tot_unassign_trips'];  echo '\';
var av_drv	 = \'';  echo $this->_tpl_vars['tot_availble_drivers'];  echo '\';
var date	 = \'';  echo $this->_tpl_vars['date'];  echo '\';
...
<div class="btn_main">
<div class="btn_bg_sec"><a href="selectdrivers.php?date=<?php echo $this->_tpl_vars['date']; ?>
" rel="facebox">Select Drivers</a></div>
<div class="btn_bg"><a href="nextdaygrid.php?date=<?php echo $this->_tpl_vars['date']; ?>
">Back To Grid</a></div>

<div class="btn_bg_sec"><a href="index.php">Home</a></div>
<div class="btn_bg"><a href="rescheduale.php?date=<?php echo $this->_tpl_vars['date']; ?>
">Revert All Assignment</a></div>
<div class="btn_bg1"><a href="javascript:popWind78('driver_schedule4.php?date=<?php echo $this->_tpl_vars['date']; ?>
')" ><img src="timeslots.png" title="" height="50px" width="90px" /></a><!--<a href="driver_schedule4.php?date=<?php echo $this->_tpl_vars['date']; ?>
" target="_blank">Drivers Time Slots</a>--></div>
...
<table width="450" border="0" cellspacing="0" cellpadding="0">
  <tr>
    ...
    <td width="321" align="left" class="driver_num"><?php echo $this->_tpl_vars['totdrivers']; ?>
</td>
  </tr>
  <tr>
    <td width="229" height="28" class="driver_head">Selected Drivers:</td>
    <td align="left" class="driver_num"><?php echo $this->_tpl_vars['tot_availble_drivers']; ?>
</td>
  </tr>
  <tr>
    <td  width="229" class="driver_head">Total Number of Trips:</td>
    <td align="left" class="driver_num"><p id="tot"><?php echo $this->_tpl_vars['tot_trips']; ?>
</p></td>
  </tr>
  <tr>
    <td width="229" height="28" class="driver_head">Total Number of Assign Trips:</td>
    <td align="left" class="driver_num"><p id="tat"><?php echo $this->_tpl_vars['tot_assign_trips']; ?>
</p></td>
  </tr>
  <tr>
    <td width="229" height="28" class="driver_head">Total Number of Un-assign Trips:</td>
    <td align="left" class="driver_num"><p id="tut"><?php echo $this->_tpl_vars['tot_unassign_trips']; ?>
</p></td>
  </tr>
</table>

</div>
<a <?php if ($this->_tpl_vars['tot_availble_drivers'] > 0): ?> href="#" onclick="recursMe(1,<?php echo $this->_tpl_vars['percentage']; ?>
);" <?php else: ?>  href="#" onclick="alert('Before starting Auto Schedual,  Please select some drivers');" <?php endif; ?> > <div class="verti_bg">
Start<br/ > Auto<br/ > 
Schedule
</div>
</a>
<!--<a <?php if ($this->_tpl_vars['tot_availble_drivers'] > 0): ?> href="#" onclick="autoSCHbusy();" <?php else: ?>  href="#" onclick="alert('Before starting Auto Schedual,  Please select some drivers');" <?php endif; ?> > <div class="verti_bg">
Busy<br/ > Day<br/ > 
Schedule
</div>
</a>-->
...
@keyframes sk-stretchdelay {
  ...
  <div class="rect5"></div>
    ...
    <p class="triggerBar">Total Trips: <span id="tot2" >&raquo; <?php echo $this->_tpl_vars['tot_trips']; ?>
</span> &nbsp;&nbsp;&nbsp; | &nbsp;&nbsp;&nbsp; Assign Trips: <span id="tat2" >&raquo; <?php echo $this->_tpl_vars['tot_assign_trips']; ?>
</span>&nbsp;&nbsp;&nbsp; | &nbsp;&nbsp;&nbsp; Remaining Trips: <span id="tut2" >&raquo; <?php echo $this->_tpl_vars['tot_unassign_trips']; ?>
</span></p>
