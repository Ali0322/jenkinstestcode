<?php /* Smarty version 2.6.12, created on 2020-01-09 15:59:18
...
&st=active<?php if ($this->_tpl_vars['startdate'] != ''): ?>&startdate=<?php echo $this->_tpl_vars['startdate'];  endif;  if ($this->_tpl_vars['enddate'] != ''): ?>&enddate=<?php echo $this->_tpl_vars['enddate'];  endif;  if ($this->_tpl_vars['pname'] != ''): ?>&pname=<?php echo $this->_tpl_vars['pname'];  endif; ?>&by_date=<?php echo $this->_tpl_vars['by_date'];  if ($this->_tpl_vars['apptype'] != ''): ?>&apptype=<?php echo $this->_tpl_vars['apptype'];  endif; ?>" target="_blank">Pending</a> |
                                <a href="reqdetails.php?req=<?php echo $this->_tpl_vars['reqdetails'][$this->_sections['q']['index']]['account']; ?>
&st=approved<?php if ($this->_tpl_vars['startdate'] != ''): ?>&startdate=<?php echo $this->_tpl_vars['startdate'];  endif;  if ($this->_tpl_vars['enddate'] != ''): ?>&enddate=<?php echo $this->_tpl_vars['enddate'];  endif;  if ($this->_tpl_vars['pname'] != ''): ?>&pname=<?php echo $this->_tpl_vars['pname'];  endif; ?>&by_date=<?php echo $this->_tpl_vars['by_date'];  if ($this->_tpl_vars['apptype'] != ''): ?>&apptype=<?php echo $this->_tpl_vars['apptype'];  endif; ?>"  target="_blank">Approved</a> |
                                <a href="reqdetails.php?req=<?php echo $this->_tpl_vars['reqdetails'][$this->_sections['q']['index']]['account']; ?>
&st=disapproved<?php if ($this->_tpl_vars['startdate'] != ''): ?>&startdate=<?php echo $this->_tpl_vars['startdate'];  endif;  if ($this->_tpl_vars['enddate'] != ''): ?>&enddate=<?php echo $this->_tpl_vars['enddate'];  endif;  if ($this->_tpl_vars['pname'] != ''): ?>&pname=<?php echo $this->_tpl_vars['pname'];  endif; ?>&by_date=<?php echo $this->_tpl_vars['by_date'];  if ($this->_tpl_vars['apptype'] != ''): ?>&apptype=<?php echo $this->_tpl_vars['apptype'];  endif; ?>"  target="_blank">Disapproved</a>

								 <?php else: ?>

<?php if ($this->_tpl_vars['reqdetails'][$this->_sections['q']['index']]['active'] > 0): ?>
                                <a href="reqdetails.php?req=<?php echo $this->_tpl_vars['reqdetails'][$this->_sections['q']['index']]['account']; ?>
&cisid=<?php echo $this->_tpl_vars['reqdetails'][$this->_sections['q']['index']]['cisid']; ?>
&st=active<?php if ($this->_tpl_vars['startdate'] != ''): ?>&startdate=<?php echo $this->_tpl_vars['startdate'];  endif;  if ($this->_tpl_vars['enddate'] != ''): ?>&enddate=<?php echo $this->_tpl_vars['enddate'];  endif; ?>&by_date=<?php echo $this->_tpl_vars['by_date'];  if ($this->_tpl_vars['apptype'] != ''): ?>&apptype=<?php echo $this->_tpl_vars['apptype'];  endif; ?>&<?php if ($this->_tpl_vars['pname'] != ''): ?>&pname=<?php echo $this->_tpl_vars['pname'];  endif; ?>"  target="_blank">Active(<?php echo $this->_tpl_vars['reqdetails'][$this->_sections['q']['index']]['active']; ?>
)</a><?php else: ?>Active(<?php echo $this->_tpl_vars['reqdetails'][$this->_sections['q']['index']]['active']; ?>
)<?php endif; ?> 
                                
                                | <?php if ($this->_tpl_vars['reqdetails'][$this->_sections['q']['index']]['approved'] > 0): ?>
                                <a href="reqdetails.php?req=<?php echo $this->_tpl_vars['reqdetails'][$this->_sections['q']['index']]['account']; ?>
&cisid=<?php echo $this->_tpl_vars['reqdetails'][$this->_sections['q']['index']]['cisid']; ?>
&st=approved<?php if ($this->_tpl_vars['startdate'] != ''): ?>&startdate=<?php echo $this->_tpl_vars['startdate'];  endif;  if ($this->_tpl_vars['enddate'] != ''): ?>&enddate=<?php echo $this->_tpl_vars['enddate'];  endif; ?>&by_date=<?php echo $this->_tpl_vars['by_date'];  if ($this->_tpl_vars['apptype'] != ''): ?>&apptype=<?php echo $this->_tpl_vars['apptype'];  endif; ?>&<?php if ($this->_tpl_vars['pname'] != ''): ?>&pname=<?php echo $this->_tpl_vars['pname'];  endif; ?>"  target="_blank">Approved(<?php echo $this->_tpl_vars['reqdetails'][$this->_sections['q']['index']]['approved']; ?>
)</a><?php else: ?>Approved(<?php echo $this->_tpl_vars['reqdetails'][$this->_sections['q']['index']]['approved']; ?>
)<?php endif; ?>
                                
                                | <?php if ($this->_tpl_vars['reqdetails'][$this->_sections['q']['index']]['disapproved'] > 0): ?> |
                                <a href="reqdetails.php?req=<?php echo $this->_tpl_vars['reqdetails'][$this->_sections['q']['index']]['account']; ?>
&cisid=<?php echo $this->_tpl_vars['reqdetails'][$this->_sections['q']['index']]['cisid']; ?>
&st=disapproved<?php if ($this->_tpl_vars['startdate'] != ''): ?>&startdate=<?php echo $this->_tpl_vars['startdate'];  endif;  if ($this->_tpl_vars['enddate'] != ''): ?>&enddate=<?php echo $this->_tpl_vars['enddate'];  endif; ?>&by_date=<?php echo $this->_tpl_vars['by_date'];  if ($this->_tpl_vars['apptype'] != ''): ?>&apptype=<?php echo $this->_tpl_vars['apptype'];  endif; ?>&<?php if ($this->_tpl_vars['pname'] != ''): ?>&pname=<?php echo $this->_tpl_vars['pname'];  endif; ?>"  target="_blank">Disapproved(<?php echo $this->_tpl_vars['reqdetails'][$this->_sections['q']['index']]['disapproved']; ?>
)</a><?php else: ?>Disapproved(<?php echo $this->_tpl_vars['reqdetails'][$this->_sections['q']['index']]['disapproved']; ?>
)<?php endif; ?>								
