<?php /* Smarty version 2.6.12, created on 2020-09-29 11:42:49
         compiled from mntncetpl/add.tpl */ ?>
<?php echo '
  ...
  <tr>
    ...
    <td><table width="100%" border="0" cellspacing="0" cellpadding="0">
        ...
        <tr>
          ...
          <td height="44" align="center"  valign="top" style="padding-bottom:50px;"><form name="add_men" id="add_men" method="post" action="add.php">

              <table width="80%" border="0" cellspacing="2" cellpadding="2" align="center" style="border:#999999 1px solid; padding:5px;">
			  <tr>
...
"><?php echo $this->_tpl_vars['vehicles'][$this->_sections['q']['index']]['vname']; ?>
 - [<?php echo $this->_tpl_vars['vehicles'][$this->_sections['q']['index']]['vnumber']; ?>
                  ...
                  <td colspan="2" align="left" valign="middle"><span class="SmallnoteTxt">
                    ...
                    <input name="date" type="text"  class="validate[required] inputTxtField" id="date" value="<?php echo $this->_tpl_vars['date']; ?>
" />
                ...
                <tr>
                  ...
                  <td colspan="2" align="left" valign="middle"><select name="type" id="type"  class="validate[required] inputTxtField">
...
"><?php echo $this->_tpl_vars['types'][$this->_sections['q']['index']]['mentype']; ?>
</option>
  ...
  <tr>
                ...
                <tr>
                  ...
                  <td colspan="2" align="left" valign="middle"><textarea name="desc" id="desc" class="validate[required,length[6,200]] inputTxtField"></textarea>&nbsp;<span class="SmallnoteTxt">*</span></td>
  ...
  <tr>
                ...
                <tr>
                  ...
                  <td colspan="2" align="left" valign="middle"><input name="cost" type="text"  class="validate[required,custom[onlyNumber]] inputTxtField digits" id="cost" value="<?php echo $this->_tpl_vars['cost']; ?>
" maxlength="6"/>
 ...
 <?php echo $this->_tpl_vars['dlist'][$this->_sections['n']['index']]['lname']; ?>
			   ...
			   <?php endfor; endif; ?>
                ...
                <tr>
                  ...
                  <td colspan="2" align="center"><input type="submit" name="update" value="  Add  " class="inputButton btn" id="update"></td>
