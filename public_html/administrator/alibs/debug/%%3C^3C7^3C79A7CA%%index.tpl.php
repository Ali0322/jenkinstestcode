<?php /* Smarty version 2.6.12, created on 2020-08-05 15:15:01
         compiled from rpaneltpl/index.tpl */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('function', 'cycle', 'rpaneltpl/index.tpl', 418, false),array('modifier', 'date_format', 'rpaneltpl/index.tpl', 421, false),)), $this); ?>
...
$this->_sections['q']['loop'] = is_array($_loop=$this->_tpl_vars['vehdetail']) ? count($_loop) : max(0, (int)$_loop); unset($_loop);
...
?>
              <?php if ($this->_tpl_vars['vehdetail'][$this->_sections['q']['index']]['file_name'] != ''): ?>
              <tr valign="top" bgcolor="<?php echo smarty_function_cycle(array('values' => "#eeeeee,#d0d0d0"), $this);?>
">
                <td align="left" valign="middle"><b><?php echo $this->_tpl_vars['vehdetail'][$this->_sections['q']['index']]['file_name']; ?>
</b></td>
                <td align="left" valign="middle"><?php echo $this->_tpl_vars['vehdetail'][$this->_sections['q']['index']]['admin_name']; ?>
</td>
                <td align="left" valign="middle"><?php echo $this->_tpl_vars['vehdetail'][$this->_sections['q']['index']]['timed']; ?>
&nbsp;&nbsp;<?php echo ((is_array($_tmp=$this->_tpl_vars['vehdetail'][$this->_sections['q']['index']]['dated'])) ? $this->_run_mod_handler('date_format', true, $_tmp) : smarty_modifier_date_format($_tmp)); ?>
</td>
                <td align="center" valign="middle"><a href="../routing-sheets/<?php echo $this->_tpl_vars['vehdetail'][$this->_sections['q']['index']]['sheet_name']; ?>
"><img src="../images/download_icon.png" border="0"></a></td>
                <td align="center" valign="middle"> <?php if ($this->_tpl_vars['vehdetail'][$this->_sections['q']['index']]['state'] == '1'): ?> <a href="grid.php?id=<?php echo $this->_tpl_vars['vehdetail'][$this->_sections['q']['index']]['sheet_id']; ?>
&st=5&ad=0" title="View">View</a>&nbsp;&nbsp;
                  
                  <?php endif; ?> <a href="#" onclick="return deleteRec('<?php echo $this->_tpl_vars['vehdetail'][$this->_sections['q']['index']]['sheet_id']; ?>
');" title="Remove"><img alt="Remove" border="0"  src="../graphics/delete.png" /></a> <?php if ($this->_tpl_vars['vehdetail'][$this->_sections['q']['index']]['blast'] != '1'): ?> <a href="e-blast.php?id=<?php echo $this->_tpl_vars['vehdetail'][$this->_sections['q']['index']]['sheet_id']; ?>
"><img alt="Blast Email" title="Blast Email" border="0"  src="../images/email.png" /></a> <?php endif; ?>
                  
                  
                  
                  <?php if ($this->_tpl_vars['vehdetail'][$this->_sections['q']['index']]['sms'] != '1'): ?> <a href="sms.php?id=<?php echo $this->_tpl_vars['vehdetail'][$this->_sections['q']['index']]['sheet_id']; ?>
"><!--<img alt="Blast SMS" title="Blast SMS" border="0"  src="../images/email.png" />--><img src="../images/sms.png" alt="" border="0" style="margin-top:3px;"/></a> <?php endif; ?> </td>
              </tr>
              <?php endif; ?>
