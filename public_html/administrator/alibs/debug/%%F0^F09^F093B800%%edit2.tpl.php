<?php /* Smarty version 2.6.12, created on 2020-06-24 20:30:31
         compiled from rpaneltpl/edit2.tpl */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('modifier', 'date_format', 'rpaneltpl/edit2.tpl', 1875, false),)), $this); ?>
...
</table><?php endif; ?><form action="edit2.php" method="post" id="addtrip" >
...
<option value="Round Trip" 	<?php if ($this->_tpl_vars['triptype'] == 'Round Trip'): ?>selected<?php endif; ?>>Two Way--(Round Trip)</option>
...
<input type="hidden" name="pre_triptype" value="<?php echo $this->_tpl_vars['triptype']; ?>
" /> </td>
...
<td valign="top"><select name="account" class="required"><option value="">Select Account</option><?php unset($this->_sections['q']);
...
" <?php if ($this->_tpl_vars['accounts'][$this->_sections['q']['index']]['id'] == $this->_tpl_vars['tripdata']['0']['account']): ?> selected <?php endif; ?>><?php echo $this->_tpl_vars['accounts'][$this->_sections['q']['index']]['account_name']; ?>
</option><?php endfor; endif; ?></select>         <span style="SmallnoteTxt"> * </span>		  </td>
...
<tr>
                  ...
                  <td colspan="2" align="left"><select name="oxygen"  class="txt_box required" id="oxygen" >
                       ...
                       <option value="No" <?php if ($this->_tpl_vars['tripdata']['0']['oxygen'] == 'No'): ?>selected<?php endif; ?>> No </option>

                       <option value="Yes" <?php if ($this->_tpl_vars['tripdata']['0']['oxygen'] == 'Yes'): ?>selected<?php endif; ?>> Yes </option>
...
<tr>
                ...
                <td colspan="2" align="left"><select name="cellalertoption" class="txt_box required" id="cellalertoption" onChange="textalerty(this.value)" >
                      ...
                      <option value="No" <?php if ($this->_tpl_vars['data']['0']['cellalertoption'] == 'No'): ?>selected<?php endif; ?>> No </option>

                      <option value="Yes" <?php if ($this->_tpl_vars['data']['0']['cellalertoption'] == 'Yes'): ?>selected<?php endif; ?>> Yes </option>
                 ...
                 <!--<tr id="cellalert2" style="display:none;">
                  ...
                  <option value="drop" <?php if ($this->_tpl_vars['data']['0']['trigerfor'] == 'drop'): ?>selected<?php endif; ?>> Drop off </option>

                  <option value="pick" <?php if ($this->_tpl_vars['data']['0']['trigerfor'] == 'pick'): ?>selected<?php endif; ?>> Pick Up </option>
                ...
                <tr id="cellalert" style="display:none;">
                  ...
                  <td colspan="2"><input type="text" name="cellalert"  value="<?php echo $this->_tpl_vars['data']['0']['cellalert']; ?>
...
" class="txt_box required" tabindex="4" />&nbsp;<span class="SmallnoteTxt">*</span>           		  </td>
...
<td colspan="2" valign="top"><input type="text" name="dob" id="dobnew" <?php if ($this->_tpl_vars['dob'] == '0000-00-00'): ?> value="" <?php else: ?> value="<?php echo $this->_tpl_vars['dob']; ?>
" <?php endif; ?> class="txt_box" tabindex="6" maxlength="15" /><span class="SmallnoteTxt">  e.g. yyyy-mm-dd</span>	</td>
...
<input type="text" name="po" id="po" value="<?php echo $this->_tpl_vars['tripdata']['0']['po']; ?>
"/>  &nbsp;<span class="SmallnoteTxt"></span>                                                </td>
...
<input type="text" name="patient_weight" id="patient_weight" value="<?php echo $this->_tpl_vars['tripdata']['0']['patient_weight']; ?>
...
<td colspan="2" valign="top"><input type="text" name="ssn" id="ssn" value="<?php echo $this->_tpl_vars['tripdata']['0']['ssn']; ?>
" class="txt_box " maxlength="14" /></td>
...
" class="txt_box required" maxlength="5" tabindex="24" onBlur="javascript:time_()" />&nbsp;&nbsp;
...
<?php if ($this->_tpl_vars['triptype'] == 'Four Way' || $this->_tpl_vars['triptype'] == 'Five Way' || $this->_tpl_vars['triptype'] == 'Three Way' || $this->_tpl_vars['triptype'] == 'Round Trip'):  endif; ?>
...
" tabindex="26" class="txt_box required" maxlength="5" onBlur="javascript:time1()" />&nbsp;&nbsp;
...
<option value="<?php echo $this->_tpl_vars['r_mad']; ?>
" <?php if ($this->_tpl_vars['r_mad'] == 'pm'): ?> selected <?php endif; ?> >pm</option></select>-->
...
<tr>
                  ...
                  <td ><input type="text" name="passenger" id="passenger"  class="txt_box required" value="<?php echo $this->_tpl_vars['tripdata']['0']['passenger']; ?>
" /></td>
...
<td><input type="text" name="picklocation" id="picklocation"  class="txt_box" value="<?php echo $this->_tpl_vars['tripdata']['0']['picklocation']; ?>
" size="40"  onKeyUp="searchSuggest3();"  autocomplete="off"/><div id="layer3"></div></td>
...
<td width="47%"><input type="text" name="pickaddress" id="autocomplete" value="<?php echo $this->_tpl_vars['pickaddress']; ?>
" class="txt_box required" size="40" />&nbsp;<span class="SmallnoteTxt">*</span></td>
...
" class="txt_box " maxlength="14" />&nbsp;<span class="SmallnoteTxt"></span></td>
...
<td><input type="text" name="droplocation" id="droplocation"  class="txt_box" value="<?php echo $this->_tpl_vars['tripdata']['0']['droplocation']; ?>
" size="40"   onKeyUp="searchSuggest4();"  autocomplete="off"/><div id="layer4"></div></td>
...
<td colspan="2"><input type="text" name="destination" id="autocomplete2" value="<?php echo $this->_tpl_vars['destination']; ?>
"  class="txt_box"  size="40" />&nbsp;<span class="SmallnoteTxt">*</span></td>
...
"  class="txt_box " maxlength="5" onBlur="javascript:time(this.id);" />
               ...
               <tr id="three2" style="display:none">
                  ...
                  <td><input  type="text" name="droplocation2" id="droplocation2" value="<?php echo $this->_tpl_vars['data']['0']['droplocation2']; ?>
"  class="txt_box"  size="45"  onKeyUp="searchSuggest5();"  autocomplete="off"/><div id="layer5"></div>
                ...
                <tr  id="three3" style="display:none">
                  ...
                  <td><input  type="text" name="destination2" id="autocomplete4" value="<?php echo $this->_tpl_vars['destination2']; ?>
" placeholder="Enter Address"  class="txt_box "  maxlength="150"  size="45" />
               ...
               <td><input type="text" name="dsuiteroom2" id="dsuiteroom2" value="<?php echo $this->_tpl_vars['dsuiteroom2']; ?>
"  class="txt_box"  maxlength="150"  size="45" />
                ...
                <tr  id="three5" style="display:none">
                  ...
                  <td><input type="text" name="d_phnum2" id="d_phnum2" value="<?php echo $this->_tpl_vars['data']['0']['d_phnum2']; ?>
" class="txt_box" maxlength="14"  onChange="use_same(this.id);" />
                ...
                <tr  id="three6" style="display:none">
                  ...
                  <td colspan="2"><textarea rows="3" cols="40" name="destination_instruction2" id="destination_instruction2"><?php echo $this->_tpl_vars['data']['0']['destination_instruction2']; ?>
</textarea>
...
"  class="txt_box " maxlength="5" onBlur="javascript: time(this.id);" />
                ...
                <tr id="four2" style="display:none">
                  ...
                  <td><input  type="text" name="droplocation3" id="droplocation3" value="<?php echo $this->_tpl_vars['data']['0']['droplocation3']; ?>
"  class="txt_box"  size="45"  onKeyUp="searchSuggest6();"  autocomplete="off"/><div id="layer6"></div>
                ...
                <tr  id="four3" style="display:none">
                  ...
                  <td><input  type="text" name="destination3" id="autocomplete5" value="<?php echo $this->_tpl_vars['destination3']; ?>
" placeholder="Enter Address"  class="txt_box "  maxlength="150"  size="45" />
               ...
               <td><input type="text" name="dsuiteroom3" id="dsuiteroom3" value="<?php echo $this->_tpl_vars['dsuiteroom3']; ?>
"  class="txt_box"  maxlength="150"  size="45" />
                ...
                <tr  id="four5" style="display:none">
                  ...
                  <td><input type="text" name="d_phnum3" id="d_phnum3" value="<?php echo $this->_tpl_vars['data']['0']['d_phnum3']; ?>
" class="txt_box" maxlength="14"  onChange="use_same(this.id);" />
                ...
                <tr  id="four6" style="display:none">
                  ...
                  <td colspan="2"><textarea rows="3" cols="40" name="destination_instruction3" id="destination_instruction3"><?php echo $this->_tpl_vars['data']['0']['destination_instruction3']; ?>
</textarea>
...
"  class="txt_box " maxlength="5" onBlur="javascript:tValid(this.value,this.id)" />&nbsp;&nbsp;<!--<select class="" name="am_pm5" id="am_pm5"  >
...
<td></td></tr>
 ...
 <tr id="five6" style="display:none">
               ...
               <td><input type="text" name="p5suiteroom" id="p5suiteroom" value="<?php echo $this->_tpl_vars['p5suiteroom']; ?>
"  class="txt_box"  maxlength="50" />
...
" maxlength="10" />&nbsp;<span class="SmallnoteTxt"> e.g. 12345-6789</span></td><td></td></tr>
 ...
 <?php if ($this->_tpl_vars['triptype'] == 'Four Way' || $this->_tpl_vars['triptype'] == 'Five Way' || $this->_tpl_vars['triptype'] == 'Three Way' || $this->_tpl_vars['triptype'] == '' || $this->_tpl_vars['triptype'] == 'Round Trip'): ?> <?php endif; ?>
...
<td><input type="text" name="backtolocation" id="backtolocation"  class="txt_box" value="<?php echo $this->_tpl_vars['tripdata']['0']['backtolocation']; ?>
" size="40"   onKeyUp="searchSuggest7();"  autocomplete="off"/><div id="layer7"></div>
...
<td><input name="backto" type="text"  class="txt_box " id="autocomplete3" value="<?php echo $this->_tpl_vars['backto']; ?>
...
"  class="txt_box"  maxlength="50" />
                ...
                <tr id="b3" style="display:none;">
                  ...
                  <td colspan="2"><textarea rows="3" cols="40" name="backto_instruction" id="backto_instruction"><?php echo $this->_tpl_vars['tripdata']['0']['backto_instruction']; ?>
</textarea>
...
<?php if ($this->_tpl_vars['triptype'] != ''):  endif; ?>

<?php echo '<script>chTrip(\'';  echo $this->_tpl_vars['triptype'];  echo '\');</script>'; ?>




<?php echo '<script>textalerty(\'';  echo $this->_tpl_vars['data']['0']['cellalertoption'];  echo '\');</script>'; ?>
