<?php /* Smarty version 2.6.12, created on 2020-06-08 23:21:17
...
<td height="19" align="center">&nbsp;</td>
  ...
  <tr>
    <td colspan="2">&nbsp;</td>
	 ...
	 <tr>
    <td colspan="2" height="25" align="left" class="labeltxt adjust"><b>Site URL : </b><span style="color:#FF0000">*</span><br /><input name="url" type="text" id="url" value="<?php echo $this->_tpl_vars['udata'][0]['url']; ?>
" size="40" maxlength="100" class="validate[required]" /></td>
  ...
  <tr>
    <td colspan="2" width="29%" height="25" align="left" class="labeltxt adjust"><b>Company Name  : </b><span style="color:#FF0000">*</span><br />
      <input name="cname" type="text" class="validate[required,length[0,50]]" id="cname" value="<?php echo $this->_tpl_vars['udata'][0]['cname']; ?>
...
" size="40" maxlength="50" /></td>
    ...
    <tr>
    <td colspan="2" width="29%" height="25" align="left" class="labeltxt adjust"><b>State/Province :</b> <span style="color:#FF0000">*</span><br /><input name="state" type="text" class="validate[required,custom[onlyLetter],length[0,50]]" id="state" value="<?php echo $this->_tpl_vars['udata'][0]['state']; ?>
" size="40" maxlength="50" /></td>
  </tr>
    <tr>
    <td colspan="2" width="29%" height="25" align="left" class="labeltxt adjust"><b>ZIP : </b><span style="color:#FF0000">*</span><br /><input name="zip" type="text" class="validate[required,custom[onlyZip],length[0,9]]" id="zip" value="<?php echo $this->_tpl_vars['udata'][0]['zip']; ?>
" size="40" maxlength="9" /></td>
  </tr>
   <tr>
    <td colspan="2" width="29%" height="25" align="left" class="labeltxt adjust"><img height="75" width="200" src="../<?php echo $this->_tpl_vars['udata'][0]['thumb']; ?>
"></td>
  </tr>
   <tr>
...
" size="40" maxlength="100" /></td>
      ...
      <tr>
        ...
        <tr>
		  ...
		  <input type="hidden" name="hidimage" id="hidimage" value="<?php echo $this->_tpl_vars['udata'][0]['image']; ?>
" />	
		  <input type="hidden" name="hidthumb" id="hidthumb" value="<?php echo $this->_tpl_vars['udata'][0]['thumb']; ?>
" />	  </td>
        </tr>
        <tr>
          <td align="right" valign="top">&nbsp;</td>
