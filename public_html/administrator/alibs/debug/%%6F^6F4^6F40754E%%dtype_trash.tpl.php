<?php /* Smarty version 2.6.12, created on 2022-02-23 14:57:24
         compiled from drvtpl/dtype_trash.tpl */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('function', 'cycle', 'drvtpl/dtype_trash.tpl', 95, false),)), $this); ?>
...
.</b></td>
                    ...
                    <td align="center" valign="middle"><?php echo $this->_tpl_vars['vehtypedetails'][$this->_sections['q']['index']]['dtype_name']; ?>
</td>
					...
					<a href="#" title="Restore Driver Type"  onClick="return restore('<?php echo $this->_tpl_vars['vehtypedetails'][$this->_sections['q']['index']]['dtype_id']; ?>
');"> 

					<img border="0" alt="Restore" src="../graphics/restore.png"></a>&nbsp;&nbsp;

                    <a href="#" onClick="return deleteRec('<?php echo $this->_tpl_vars['vehtypedetails'][$this->_sections['q']['index']]['dtype_id']; ?>
');" title="Remove"> 
