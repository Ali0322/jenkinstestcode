<?php /* Smarty version 2.6.12, created on 2019-12-13 18:24:32
         compiled from drvtpl/add-drvtype.tpl */ ?>
<?php echo '
	...
	<form name="add-drvtype" id="add-drvtype" method="post" action="add-drvtype.php">
								...
								<table width="650" border="0" cellspacing="2" cellpadding="2">
								  ...
								  <tr>
									...
									<td width="74%" height="25"><input name="drvtype" type="text" class="validate[required,custom[onlyLetter]] inputTxtField" id="drvtype" value="<?php echo $this->_tpl_vars['drvtype']; ?>
" maxlength="15" />
