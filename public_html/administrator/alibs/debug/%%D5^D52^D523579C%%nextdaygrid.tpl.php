<?php /* Smarty version 2.6.12, created on 2020-05-20 18:55:25
         compiled from rpaneltpl/nextdaygrid.tpl */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('modifier', 'date_format', 'rpaneltpl/nextdaygrid.tpl', 304, false),)), $this); ?>
...
//setInterval(getalerts(),10000);
	...
	function dvmap(did,tid,tdate,ttime,acknowledge_status,add1,add2)
	{
		...
		if (did != \'\' && tid != \'\' && tdate != \'\' && ttime != \'\')
		{
		   	...
		   	$.post("cnfrm.php", {drv_id: did, trp_id: tid, trp_date: tdate, trp_time:ttime}, function(cnfrm)
			{
				...
				if(cnfrm == 0)
				{
					var r=confirm("This Driver is already assign to another trip with same interval of time. \\nAre you sure you want to assign any way?");
					if(r==true){ var dup = \'1\';
	   $.post("dvmap.php", {did: did, tid: tid, tdate: tdate, ttime: ttime, acknowledge_status: acknowledge_status, dup: dup}, function(data)	{
						if(data.length > 0)
						{
							msg = data.split(\'^\');
							if(msg[1] == \'0\')
								alert("Not Assigned Yet");
							else { calcRoute(add1,add2);
								alert("Assigned"); 
								$(\'#\'+tid).removeClass( \'assign\' );
								$(\'#\'+tid).addClass( \'duplicateassign\' ); }
							return true;
						}
					});
				}else { return false; }
	...
	$.post("dvmap.php", {did: did, tid: tid, tdate: tdate, ttime: ttime, acknowledge_status: acknowledge_status, dup: dup}, function(data)
					{
						if(data.length > 0)
						{
							...
							if(msg[1] == \'0\')
								alert("Not Assigned Yet");
							else {	calcRoute(add1,add2);	alert("Assigned"); 
							$(\'#\'+tid).removeClass( \'duplicateassign\' );
							$(\'#\'+tid).addClass( \'assign\' );		 }
						return true;
						}
					});
...
function sadigalliaga(){ //alert(Usmania);
 ...
 //end of acknowledge
</script> 		<script type="text/javascript" src="http://maps.google.com/maps/api/js?sensor=false&key=AIzaSyBBE53xDKH93kCWSWREyehlzH8N_t2R2lw"></script>
...
" method="post">
          Driver: <select name="driver" id="driver" onChange="fsubmit('nextdaygrid.php?st=<?php echo $this->_tpl_vars['st']; ?>
&date=<?php echo $this->_tpl_vars['date']; ?>
',this.value);">
...
" <?php if ($this->_tpl_vars['drivers'][$this->_sections['d']['index']]['drv_code'] == $this->_tpl_vars['drv']): ?> selected="selected" <?php endif; ?>><?php echo $this->_tpl_vars['drivers'][$this->_sections['d']['index']]['fname']; ?>
 ...
 - [ <?php echo $this->_tpl_vars['drivers'][$this->_sections['d']['index']]['drv_code']; ?>
                    ...
                    <?php endfor; endif; ?>  
                                  ...
                                  Client: <select  onchange="fsubmit2('nextdaygrid.php?st=<?php echo $this->_tpl_vars['st']; ?>
&date=<?php echo $this->_tpl_vars['date']; ?>
...
" ><?php echo $this->_tpl_vars['userdata'][$this->_sections['d']['index']]['trip_user']; ?>
                    ...
                    <?php endfor; endif; ?>  
                                  ...
                                  Accounts: <select name="account" id="account"  onchange="fsubmit3('nextdaygrid.php?st=<?php echo $this->_tpl_vars['st']; ?>
&date=<?php echo $this->_tpl_vars['date']; ?>
',this.value);">
...
" ><?php echo $this->_tpl_vars['accounts'][$this->_sections['d']['index']]['account_name']; ?>
              ...
              <tr>
                <td height="19" align="center" class="admintopheading">ROUTING SHEET DETAILS <span style="color:#F00; font-weight:bold;">[ <?php echo ((is_array($_tmp=$this->_tpl_vars['date'])) ? $this->_run_mod_handler('date_format', true, $_tmp) : smarty_modifier_date_format($_tmp)); ?>
 ]  </span></td>
              </tr>
              <tr>
                <td height="44" align="center"  valign="top" style=""><table width="100%" border="0" class="main_table1" cellpadding="0" cellspacing="0" >                  
                    <div id="sc"></div>
					<tr><td colspan="12"><div style=" border: solid #FF0000 0px; padding-top:10px;">
                    <table width="100%" border="0" >
					 <tr>
                      ...
                      <td align="left" class="label_txt_heading"><strong>App. Time</strong></td>
...
" <?php if ($this->_tpl_vars['membdetail'][$this->_sections['q']['index']]['drv_id'] != '' && $this->_tpl_vars['membdetail'][$this->_sections['q']['index']]['drv_id'] != '000000' && $this->_tpl_vars['membdetail'][$this->_sections['q']['index']]['duplicate'] == '0'): ?> class="assign" <?php endif; ?>	<?php if ($this->_tpl_vars['membdetail'][$this->_sections['q']['index']]['drv_id'] != '' && $this->_tpl_vars['membdetail'][$this->_sections['q']['index']]['duplicate'] == '1'): ?> class="duplicateassign" <?php endif; ?> >
                      <td class="grid_content"><?php echo $this->_tpl_vars['membdetail'][$this->_sections['q']['index']]['ccode']; ?>
</td>
...
');" >Show Route on Map</a>-->
                   ...
                   <?php echo $this->_tpl_vars['membdetail'][$this->_sections['q']['index']]['pck_add'];  if ($this->_tpl_vars['membdetail'][$this->_sections['q']['index']]['pickup_instruction'] != ''): ?><br/>[<strong>Instruction:</strong> <?php echo $this->_tpl_vars['membdetail'][$this->_sections['q']['index']]['pickup_instruction']; ?>
                      ...
                      <td align="left" valign="top" class="grid_content">
                      	<?php echo ((is_array($_tmp=$this->_tpl_vars['membdetail'][$this->_sections['q']['index']]['org_apptime'])) ? $this->_run_mod_handler('date_format', true, $_tmp, "%H:%M") : smarty_modifier_date_format($_tmp, "%H:%M")); ?>
                      ...
                      <td align="left" valign="top" class="grid_icon grid_content">&nbsp;&nbsp;<a  href="edit2.php?id=<?php echo $this->_tpl_vars['membdetail'][$this->_sections['q']['index']]['reqid']; ?>
&date=<?php echo $this->_tpl_vars['date']; ?>
