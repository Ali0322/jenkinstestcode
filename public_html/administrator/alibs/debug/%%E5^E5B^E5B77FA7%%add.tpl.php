<?php /* Smarty version 2.6.12, created on 2019-12-16 14:21:51
         compiled from patientstpls/add.tpl */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('modifier', 'date_format', 'patientstpls/add.tpl', 79, false),)), $this); ?>
    ...
    <td valign="top"><table width="100%" border="0" cellspacing="0" cellpadding="0" align="center" bgcolor="#FFFFFF">
        <tr>
          <td><table width="100%" border="0" cellspacing="0" cellpadding="0">
              ...
              <tr>
                <td height="19" align="center" class="admintopheading">ADD NEW PATIENT</td>
              </tr>
              <tr>
...
" maxlength="15" />
                      ...
                      <tr>
                        <td colspan="3" align="center" valign="top"><input type="submit" name="admusersub" id="admusersub" value=" Add New Patient " class="btn" />
