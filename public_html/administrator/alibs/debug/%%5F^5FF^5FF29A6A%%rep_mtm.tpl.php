<?php /* Smarty version 2.6.12, created on 2020-09-23 18:56:49
         compiled from reportstpl/rep_mtm.tpl */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('function', 'cycle', 'reportstpl/rep_mtm.tpl', 135, false),array('modifier', 'date_format', 'reportstpl/rep_mtm.tpl', 142, false),)), $this); ?>
...
<table  border="0" cellspacing="0" cellpadding="0" class="outer_table" align="right" bgcolor="#FFFFFF" >
 ...
 <?php endif; ?></span></td>
        ...
        <tr>
          <td height="19" colspan="2" align="center" class="admintopheading">MTM TRIP LOG</td>
        </tr>
        <!--<tr>
...
" <?php if ($this->_tpl_vars['hosp'][$this->_sections['q']['index']]['id'] == $this->_tpl_vars['hospname']): ?> selected="selected" <?php endif; ?>><?php echo $this->_tpl_vars['hosp'][$this->_sections['q']['index']]['account_name']; ?>
                ...
                <tr>
                  ...
                  <a href="javascript:popWind('rep_print.php?startdate=<?php echo $this->_tpl_vars['stdate']; ?>
...
')" ><input type="button" value='Print Report' class="inputButton btn"  /></a>
                    &nbsp;<?php endif; ?>
                    <?php if ($_SESSION['admuser']['admin_level'] == '0' || $_SESSION['adminpermission']['mtmreports_cr'] == 'on'):  endif; ?>
        ...
        <tr>
          <td height="44" colspan="2" align="center"  valign="top" style="padding-bottom:50px;"><table width="100%" border="0" class="main_table">
              <tr class="admintopheading">
                ...
                <td width="5%" align="center"><strong>Leg ID</strong></td>
