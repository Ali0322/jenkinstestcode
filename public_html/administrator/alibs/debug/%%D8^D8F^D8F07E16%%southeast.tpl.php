<?php /* Smarty version 2.6.12, created on 2020-01-09 15:34:02
         compiled from mercytpl/southeast.tpl */ ?>
<?php echo ' 
...
if((document.addcsv.file_csv.value.lastIndexOf(".csv")==-1)) {    
...
<form name="addcsv" id="addcsv" method="post" action="southeast.php" enctype="multipart/form-data" onsubmit="return validate(this);" >
 ...
 <?php endif; ?> </td>
    ...
    <tr>
      <td class="admintopheading" style="text-align:center;">Upload Trip Sheet [ CSV ]</td>
    </tr>
    <tr>
            ...
            <td align="left" valign="top" width="100%"><table width="650" border="0" cellspacing="2" cellpadding="2">
                <tr>
                  ...
                  <td height="25"><input type="file" name="file_csv" id="file_csv" class="required" />
                    <span style="color:#FF0000"> * (.csv only)</span></td>
                </tr>
                 <!--<tr>
