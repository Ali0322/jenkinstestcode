...
$query = "SELECT CONCAT(f.clientname,'^',f.dob) as name,f.cisid,CONCAT(f.appdate,'^',f.apptime) as time,h.hospname,CONCAT(f.pickaddr,'^',f.phnum) as paddr,CONCAT(f.destination,'^',f.phnum) as daddr,f.comments,CONCAT(f.fname,'^',f.lname,'^',f.phyaddress,'^',f.phyphone) as phyaddr,f.phyaddress FROM 
			...
			//	$excel->writeLine($myArr);	
				...
				$myArr=array("Requested By:","Ahmad Chishti","","","","Today's Date:","________________");
			    ...
			    $myArr=array("Company Name:","AZ Secure Trans","","","","Sender Phone:","(480) 381 7307");
				...
				$myArr=array("","","","","","Sender Fax:","(480) 381 7307");
...
//				
	...
	$smarty->display('reportstpl/genrep.tpl');
