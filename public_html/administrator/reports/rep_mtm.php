<?php
	...
	$st9=0;$st8=0;$st7=0;$st5=0;$st4=0;$st3=0;$st2=0;$tmiles='';
	 $Qaccounts  = "SELECT * FROM " .  accounts ." WHERE TRIM(LOWER(account_name)) LIKE '%".strtolower(trim('MTM'))."%' " ;
	if($db->query($Qaccounts) && $db->get_num_rows() > 0){	$accounts = $db->fetch_all_assoc();	$hospname =  $accounts[0]['id'];}
