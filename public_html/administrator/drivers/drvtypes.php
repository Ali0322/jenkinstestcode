...
// Delete Vehicle Script
...

	{
		...
		$QueryDel = "DELETE from ".TBL_DRVTYPES." WHERE dtype_id='".$_GET['delId']."'";
   		//$QueryDel = "UPDATE ".TBL_DRVTYPES." SET del = '1', del_date = '$date', del_by = '$del_by' WHERE dtype_id='".$_GET['delId']."'";
