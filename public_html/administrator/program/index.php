...
// Delete Category Script
    ...
    if(verify($_GET['delId'],"index.php")){
   		...
   		$QueryDel = "DELETE FROM ".TBL_PROGRAM." WHERE prgid='".$_GET['delId']."'";
...
// Fetch all categories list
	...
	$QueryCounty = "SELECT COUNT(*) AS rows FROM ".TBL_PROGRAM;
	...
	$Query = "SELECT * FROM ".TBL_PROGRAM." ORDER BY `prgtitle` ASC LIMIT $offset, $limit";

	$Query2 = "SELECT * FROM ".TBL_PROGRAM." ORDER BY `prgtitle` ASC";
   ...
   // Footer paging
	...
	$smarty->display('prgtpl/index.tpl');
