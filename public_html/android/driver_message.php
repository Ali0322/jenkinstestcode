...
include_once('DatabaseUS.inc.php');
	...
	$datetime 		= $time['tym'];
	$query = "INSERT INTO alerts SET alerts.to = 'admin', alerts.from = '$driverID', message = '$message', sent = '$datetime'";										if($db->execute($query)) {$jsonarray['status'] = 'true';} else {$jsonarray['status'] = 'false';}
