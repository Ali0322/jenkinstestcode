...
<title>{$smarty.const.SITE_TITLE} | {$page_title}</title>
...
{/literal}
{if $pgName neq 'index.php'}
		{if $smarty.session.user neq ''}
		{literal}
		<SCRIPT SRC="scripts/ssm.js" language="JavaScript1.2"></SCRIPT>
		{/literal}{if $smarty.session.allowUser neq '0'}{literal}
		<SCRIPT SRC="scripts/ssmItems.js" language="JavaScript1.2"></SCRIPT>
		{/literal}{else}{literal}<SCRIPT SRC="scripts/ssmItems2.js" language="JavaScript1.2"></SCRIPT>{/literal}{/if}{literal}
		{/literal}
		{/if}
{/if}
