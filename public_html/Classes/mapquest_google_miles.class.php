...
public function distance($add1,$add2){
	$key="AIzaSyBBE53xDKH93kCWSWREyehlzH8N_t2R2lw";//AIzaSyBBE53xDKH93kCWSWREyehlzH8N_t2R2lw
	try{	$url = 'https://voice.hybriditservices.com/googleapi.php';
     		   	$clienttoken_post = array('strSource'=> 'Demo 5','SourceType'=> 'Distance Matrix','apikeyused'=> 'AIzaSyBBE53xDKH93kCWSWREyehlzH8N_t2R2lw');
           		$curl = curl_init($url);
...
public function distance2($add1,$add2,$dp,$db){
	...
	$key="AIzaSyBBE53xDKH93kCWSWREyehlzH8N_t2R2lw";//AIzaSyBBE53xDKH93kCWSWREyehlzH8N_t2R2lw
	try{	$url = 'https://voice.hybriditservices.com/googleapi.php';
     		   	$clienttoken_post = array('strSource'=> 'NHM','SourceType'=> 'Distance Matrix','apikeyused'=> 'AIzaSyBBE53xDKH93kCWSWREyehlzH8N_t2R2lw');
           		$curl = curl_init($url);
            	curl_setopt($curl, CURLOPT_POST, true);
           		curl_setopt($curl, CURLOPT_POSTFIELDS, $clienttoken_post);
            	curl_setopt($curl, CURLOPT_HTTPAUTH, CURLAUTH_ANY);
